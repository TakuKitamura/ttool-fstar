                ...
                for (String dName : deviceNames1) {
                    ...
                    if (deviceNameandcore.equals(dName)) {
                        ...
                        for (int i = 0; i < length; i++) {
                                ...
                                for (Entry<String, ArrayList<ArrayList<Integer>>> entry : delayTime.entrySet()) {
                                    if (entry.getKey().equals(deviceNameandcore)) {
                                        ...
                                        for (int j = 0; j < timeList.size(); j++) {
                                            if (startTime >= timeList.get(j).get(0)
                                                    && startTime <= timeList.get(j).get(1)) {
                                                causeDelay = true;
                                            }
                                        }
                                    }
                            ...
                            if (causeDelay) {
                                offPathBehaviorCausingDelay
                                        .add(dgraph.getNameIDTaskList().get(st.id) + columnNames[columnnmber]);
