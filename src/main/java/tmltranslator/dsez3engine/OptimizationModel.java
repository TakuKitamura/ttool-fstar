...
public class OptimizationModel {
  ...
  public OptimizationResult findFeasibleMapping(Context ctx) {
    ...
    IntExpr[][] X = new IntExpr[inputInstance.getModeling().getTasks().size()][inputInstance.getArchitecture().getCPUs()
        .size()]; // getCPUs returns only HwCPU elements
    ...
    BoolExpr[][] c_bound_x = new BoolExpr[inputInstance.getModeling().getTasks().size()][inputInstance.getArchitecture()
        .getCPUs().size()];
