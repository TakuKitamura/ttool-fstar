...
public class vertex {
    ...
    public static final int TYPE_FOR_EVER_LOOP = 1;
    public static final int TYPE_STATIC_FOR_LOOP = 2;
    public static final int TYPE_FOR_LOOP = 3;
    public static final int TYPE_START = 4;
    public static final int TYPE_END = 5;
    public static final int TYPE_CHOICE = 6;
    public static final int TYPE_SEQ = 7;
    public static final int TYPE_UNORDER_SEQ = 8;
    public static final int TYPE_TRANSACTION = 9;
    public static final int TYPE_CTRL = 10;
