...
public class JFrameCompareLatencyDetail extends JFrame implements ActionListener {
    ...
    public JFrameCompareLatencyDetail(LatencyDetailedAnalysisMain latencyDetailedAnaly, MainGUI mgui,
            final Vector<String> checkedTransactionsFile1, TMLMapping<TGComponent> map1,
            List<TMLComponentDesignPanel> cpanels1, final SimulationTrace selectedST1, boolean b,
        ...
        scrollPane21 = new JScrollPane(table21, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
                JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
        ...
        // table12.setBackground(Color.blue);
        scrollPane22 = new JScrollPane(table22, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
                JScrollPane.HORIZONTAL_SCROLLBAR_ALWAYS);
    ...
    public void latencyDetailedAnalysis(String task1, String task2, String task3, String task4,
            Vector<SimulationTransaction> transFile1, Vector<SimulationTransaction> transFile2, boolean b,
    ...
    protected void compareLatencyInDetails(int row1, int row2, int row3, int row4, int selectedIndex)
