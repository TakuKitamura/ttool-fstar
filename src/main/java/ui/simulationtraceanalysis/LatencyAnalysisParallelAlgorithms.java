...
public class LatencyAnalysisParallelAlgorithms implements Runnable {
    ...
    public void latencyDetailedAnalysis(JFrameCompareLatencyDetail jFrameCompareLatencyDetail, String task12,
            String task22, String task32, String task42, Vector<SimulationTransaction> transFile12,
            Vector<SimulationTransaction> transFile22) {
    ...
    public void compareLatencyInDetails(JFrameCompareLatencyDetail jFrameCompareLatencyDetail, int row11, int row22,
            int row33, int row44, int selectedIndex1) {
        cld = jFrameCompareLatencyDetail;
        row1 = row11;
        row2 = row22;
        row3 = row33;
