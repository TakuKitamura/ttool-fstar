...
public abstract class TADConnector extends TGConnector {
    ...
    public TADConnector(int _x, int _y, int _minX, int _maxX, int _minY, int _maxY, boolean _pos, TGComponent _father,
     ...
     * Issue #69
     * 
     * @return : boolean value allows to verify the connector stage in Activity
     *         Diagram
     */
