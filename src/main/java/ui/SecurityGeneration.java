...
public class SecurityGeneration implements Runnable {
  ...
  public SecurityGeneration(MainGUI gui, String name, TMLMapping<TGComponent> map, TMLArchiPanel newarch,
      String encComp, String overhead, String decComp, boolean autoConf, boolean autoWeakAuth, boolean autoStrongAuth,
      Map<String, List<String>> selectedCPUTasks) {
    ...
    try {
      ...
      for (AvatarPragmaSecret pragma : confResults.keySet()) {
        ...
        if (confResults.get(pragma).isProved() && !confResults.get(pragma).isSatisfied()) {
          ...
          TraceManager.addDev(
              "SECGEN:" + pragma.getArg().getBlock().getName() + "." + pragma.getArg().getName() + " is not secret");
  ...
  public boolean portInTask(TMLTask task, String portName) {
    TMLActivityDiagramPanel tad = tmlcdp.getTMLActivityDiagramPanel(task.getName());// FIXME ( getActivityDiagramName(
                                                                                    // task ) );
  ...
  public void run() {
    ...
    for (TMLTask task : map.getTMLModeling().getTasks()) {
      ...
      for (TMLChannel chan : tmlmodel.getChannels(task)) {
        ...
        if (chan.isBasicChannel()) {
          ...
          if (nonConfChans.contains(
              chan.getOriginTask().getName().split("__")[1] + "__" + chan.getOriginPort().getName() + "_chData")) {
            nonConf = true;
            ...
            if (chan.checkConf && autoConf && nonConf) {
              ...
              if (hsmTasks.contains(chan.getOriginTask().getName().split("__")[1])) {
                ...
                if (!hsmSecOutChannels.get(chan.getOriginTask()).contains(chanName)
                  ...
                  HSMChannel hsmchan = new HSMChannel(chanName, chan.getOriginTask().getName().split("__")[1],
                      HSMChannel.SENC);
                  ...
                  if (chan.checkAuth && autoStrongAuth) {
                    ...
                    hsmchan.nonceName = "nonce_" + chan.getDestinationTask().getName().split("__")[1] + "_"
              ...
              if (hsmTasks.contains(chan.getDestinationTask().getName().split("__")[1])) {
                if (!hsmSecInChannels.get(chan.getDestinationTask()).contains(chanName)
                  ...
                  HSMChannel hsmchan = new HSMChannel(chanName, chan.getDestinationTask().getName().split("__")[1],
                      HSMChannel.DEC);
    ...
    // channels, etc
    for (String cpuName : selectedCPUTasks.keySet()) {
      TMLCPrimitiveComponent hsm = new TMLCPrimitiveComponent(0, tcdp.getMaxY() - 200, tcdp.getMinX(), tcdp.getMaxX(),
          tcdp.getMinY(), tcdp.getMaxY(), false, null, tcdp);
      ...
      for (TMLCPrimitiveComponent comp : comps) {
        ...
        for (ChannelData hsmChan : hsmChans) {
          ...
          TMLCChannelOutPort destPort = new TMLCChannelOutPort(comp.getX(), comp.getY(), tcdp.getMinX(), tcdp.getMaxX(),
              tcdp.getMinY(), tcdp.getMaxX(), true, comp, tcdp);
    ...
    for (String cpuName : selectedCPUTasks.keySet()) {
      ...
      TMLArchiConnectorNode connect = new TMLArchiConnectorNode(cpu.getX() + 100, archPanel.getMaxY() - 300,
          archPanel.getMinX(), archPanel.getMaxX(), archPanel.getMinY(), archPanel.getMaxY(), true, null, archPanel,
      ...
      connect = new TMLArchiConnectorNode(cpu.getX() + 100, cpu.getY() + 100, archPanel.getMinX(), archPanel.getMaxX(),
          archPanel.getMinY(), archPanel.getMaxY(), true, null, archPanel, null, null, new Vector<Point>());
    ...
    for (TMLTask task : toSecureRev.keySet()) {
      ...
      for (TMLTask task2 : toSecureRev.get(task)) {
        ...
        if (addChan) {
          TMLCChannelOutPort originPort = new TMLCChannelOutPort(0, 0, tcdp.getMinX(), tcdp.getMaxX(), tcdp.getMinY(),
              tcdp.getMaxX(), true, null, tcdp);
          TMLCChannelOutPort destPort = new TMLCChannelOutPort(0, 0, tcdp.getMinX(), tcdp.getMaxX(), tcdp.getMinY(),
              tcdp.getMaxX(), true, null, tcdp);

          if (task.getReferenceObject() instanceof TMLCPrimitiveComponent) {
            TGComponent tg = (TGComponent) task.getReferenceObject();
            originPort = new TMLCChannelOutPort(tg.getX(), tg.getY(), tcdp.getMinX(), tcdp.getMaxX(), tcdp.getMinY(),
                tcdp.getMaxX(), true, tg, tcdp);
          ...
          if (task2.getReferenceObject() instanceof TMLCPrimitiveComponent) {
            ...
            destPort = new TMLCChannelOutPort(tg.getX(), tg.getY(), tcdp.getMinX(), tcdp.getMaxX(), tcdp.getMinY(),
                tcdp.getMaxX(), true, tg, tcdp);
          ...
          tmlmodel.addChannel(new TMLChannel(
              "nonceCh" + task.getName().split("__")[1] + "_" + task2.getName().split("__")[1], originPort));
          // Add connection
          TMLCPortConnector conn = new TMLCPortConnector(0, 0, tcdp.getMinX(), tcdp.getMaxX(), tcdp.getMinY(),
              tcdp.getMaxX(), true, null, tcdp, originPort.getTGConnectingPointAtIndex(0),
              destPort.getTGConnectingPointAtIndex(0), new Vector<Point>());
    ...
    for (TMLTask task : toSecure.keySet()) {
      ...
      for (String channel : secOutChannels.get(task)) {
        ...
        for (TGComponent comp : channelInstances) {
          ...
          TMLADEncrypt enc = new TMLADEncrypt(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(),
          ...
          if (nonceOutChannels.get(task).contains(channel)) {
            ...
            rd = new TMLADReadChannel(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
                false, null, tad);
            ...
            fromStart = new TGConnectorTMLAD(enc.getX(), enc.getY(), tad.getMinX(), tad.getMaxX(), tad.getMinY(),
      ...
      for (String channel : hsmSecOutChannels.get(task)) {
        ...
        for (TGComponent chan : channelInstances) {
          ...
          TMLADSendRequest req = new TMLADSendRequest(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(),
              tad.getMaxY(), false, null, tad);
          ...
          TMLADWriteChannel wr = new TMLADWriteChannel(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(),
              tad.getMaxY(), false, null, tad);

          yShift += 50;
          // Add write channel operator
          wr = new TMLADWriteChannel(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
              false, null, tad);
          ...
          TMLADReadChannel rd = new TMLADReadChannel(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(),
              tad.getMaxY(), false, null, tad);
          ...
          if (nonceOutChannels.get(task).contains(channel)) {
            ...
            fromStart = new TGConnectorTMLAD(rd.getX(), rd.getY(), tad.getMinX(), tad.getMaxX(), tad.getMinY(),
                tad.getMaxY(), false, null, tad, null, null, new Vector<Point>());
            tad.addComponent(fromStart, xpos, ypos, false, true);
            fromStart.setP1(rd.getTGConnectingPointAtIndex(1));
            ...
            yShift += 50;
            wr2 = new TMLADWriteChannel(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
                false, null, tad);
            ...
            TGConnectorTMLAD tmp = new TGConnectorTMLAD(wr2.getX(), wr2.getY() + yShift, tad.getMinX(), tad.getMaxX(),
                tad.getMinY(), tad.getMaxY(), false, null, tad, rd.getTGConnectingPointAtIndex(1),
          ...
          yShift += 60;
          TMLADReadChannel rd2 = new TMLADReadChannel(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(),
              tad.getMaxY(), false, null, tad);
      ...
      for (String channel : hsmSecInChannels.get(task)) {
        ...
        for (TGComponent chan : channelInstances) {
          ...
          TMLADEncrypt nonce = new TMLADEncrypt(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(),
              tad.getMaxY(), false, null, tad);
          ...
          if (nonceInChannels.get(task).contains(channel)) {
            ...
            yShift += 60;
            nonce = new TMLADEncrypt(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
                false, null, tad);
            ...
            wr3 = new TMLADWriteChannel(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
                false, null, tad);
            ...
            wr3.makeValue();
            TGConnector tmp = new TGConnectorTMLAD(wr3.getX(), wr3.getY() + yShift, tad.getMinX(), tad.getMaxX(),
                tad.getMinY(), tad.getMaxY(), false, null, tad, nonce.getTGConnectingPointAtIndex(1),
                wr3.getTGConnectingPointAtIndex(0), new Vector<Point>());
            tad.addComponent(tmp, xpos, ypos, false, true);
            ...
            tmp = new TGConnectorTMLAD(wr2.getX(), wr2.getY() + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(),
                tad.getMaxY(), false, null, tad, wr3.getTGConnectingPointAtIndex(1), wr2.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
            tad.addComponent(tmp, xpos, ypos, false, true);

            fromStart = new TGConnectorTMLAD(wr2.getX(), wr.getY(), tad.getMinX(), tad.getMaxX(), tad.getMinY(),
                tad.getMaxY(), false, null, tad, wr2.getTGConnectingPointAtIndex(1), null, new Vector<Point>());
            tad.addComponent(fromStart, xpos, ypos, false, true);
      ...
      for (String channel : macInChannels.get(task)) {
        ...
        for (TGComponent comp : channelInstances) {
          ...
          TMLADWriteChannel wr = new TMLADWriteChannel(0, 0, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
              false, null, tad);
          ...
          if (nonceInChannels.get(task).contains(channel)) {
            ...
            tad.addComponent(wr, xpos, ypos + yShift, false, true);
            wr.makeValue();
            TGConnector tmp = new TGConnectorTMLAD(wr.getX(), wr.getY() + yShift, tad.getMinX(), tad.getMaxX(),
                tad.getMinY(), tad.getMaxY(), false, null, tad, nonce.getTGConnectingPointAtIndex(1),
            ...
            fromStart = new TGConnectorTMLAD(wr.getX(), wr.getY(), tad.getMinX(), tad.getMaxX(), tad.getMinY(),
                tad.getMaxY(), false, null, tad, wr.getTGConnectingPointAtIndex(1), null, new Vector<Point>());
            tad.addComponent(fromStart, xpos, ypos, false, true);
            // Connect created write channel operator to start of read channel operator
            fromStart.setP1(wr.getTGConnectingPointAtIndex(1));
            fromStart.setP2(point);
          ...
          TMLADDecrypt dec = new TMLADDecrypt(xpos + 10, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(),
              tad.getMaxY(), false, null, tad);
          ...
          yShift += 60;
          conn = new TGConnectorTMLAD(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
              false, null, tad, dec.getTGConnectingPointAtIndex(1), next, new Vector<Point>());
      ...
      for (String channel : secInChannels.get(task)) {
        ...
        for (TGComponent comp : channelInstances) {
          ...
          TMLADWriteChannel wr = new TMLADWriteChannel(0, 0, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
              false, null, tad);
          TMLADEncrypt nonce = new TMLADEncrypt(0, 0, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(), false,
              null, tad);
          if (nonceInChannels.get(task).contains(channel)) {
            // Create a nonce operator and a write channel operator
            nonce = new TMLADEncrypt(xpos, ypos + yShift, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
  ...
  public void buildHSMActivityDiagram(String cpuName) {
    ...
    if (hsmChannelMap.get(cpuName).size() == 0) {
      TMLADStopState stop = new TMLADStopState(100, 100, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
          false, null, tad);
    ...
    TMLADChoice choice = new TMLADChoice(300, 200, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(), false,
        null, tad);
    ...
    if (hsmChannelMap.get(cpuName).size() > 3) {
      TMLADChoice choice2 = new TMLADChoice(xc, 400, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(), false,
          null, tad);
      int i = 0;
      for (HSMChannel ch : hsmChannelMap.get(cpuName)) {
        ...
        if (i % 3 == 0) {
          ...
          choice2 = new TMLADChoice(xc, 250, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(), false, null,
              tad);
        ...
        TMLADReadChannel rd = new TMLADReadChannel(xc, 300, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
            false, null, tad);
        ...
        if (ch.secType == HSMChannel.DEC) {
          TMLADDecrypt dec = new TMLADDecrypt(xc, 500, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
              false, null, tad);
          ...
          TMLADEncrypt enc = new TMLADEncrypt(xc, 500, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
              false, null, tad);
          ...
          // Add Stop
          TMLADStopState stop = new TMLADStopState(xc, 600, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
              false, null, tad);
      ...
      for (HSMChannel ch : hsmChannelMap.get(cpuName)) {
        ...
        fromStart = new TGConnectorTMLAD(xc, 350, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(), false,
            null, tad, null, null, new Vector<Point>());
        fromStart.setP1(rd.getTGConnectingPointAtIndex(1));
        ...
        if (!ch.nonceName.equals("")) {
          ...
          rd = new TMLADReadChannel(xc, 350, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(), false, null,
              tad);
          rd.setChannelName("data_" + ch.name + "_" + ch.task);
        ...
        if (ch.secType == HSMChannel.DEC) {
          ...
          // Add Stop
          TMLADStopState stop = new TMLADStopState(xc, 700, tad.getMinX(), tad.getMaxX(), tad.getMinY(), tad.getMaxY(),
              false, null, tad);
          tad.addComponent(stop, xc, 700, false, true);
