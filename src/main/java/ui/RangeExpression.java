...
public class RangeExpression extends Expression {
    ...
    public RangeExpression(final String minExpressionText, final String maxExpressionText, final String nullText,
            final String labelGlobal, final String labelValues, final String labelOneNull) {
