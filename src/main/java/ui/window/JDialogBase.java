...
/**
 * Class JDialogBase Superclass for dialog inheritance Creation: 19/09/2017
 * 
...
public class JDialogBase extends JDialog {
  ...
  protected void initButtons(GridBagConstraints c0, Container c, ActionListener al) {
    initMainButtons(c0, c, al, false, "Save and Close", "Cancel");
  }

  protected void initMainButtons(GridBagConstraints c0, Container c, ActionListener al, boolean isInverse,
      String closeButtonStr, String cancelButtonStr) {
    // Close Button
    if (isInverse) {
  ...
  protected void initButtons(Container c, ActionListener al) {
