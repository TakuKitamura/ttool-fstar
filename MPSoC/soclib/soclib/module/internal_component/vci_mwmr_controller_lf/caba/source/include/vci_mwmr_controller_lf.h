 ...
 * Maintainers: nipo
 */
#ifndef SOCLIB_VCI_MWMR_CONTROLLER_LF_H
#define SOCLIB_VCI_MWMR_CONTROLLER_LF_H
...
private:
	...
	sc_signal<uint32_t> r_size_before;
	sc_signal<uint32_t> r_size_after;
	sc_signal<uint32_t> r_tail;
	sc_signal<uint32_t> r_data_xfer_bytes;
	sc_signal<uint32_t> r_data_xfer_bytes_done;
...
protected:
    SC_HAS_PROCESS(VciMwmrControllerLf);
...
#endif /* SOCLIB_VCI_MWMR_CONTROLLER_LF_H */
