/* -*- c++ -*-
 * File : vci_vcache_wrapper_multi.h
...
#ifndef SOCLIB_CABA_VCI_VCACHE_WRAPPER_MULTI_H
#define SOCLIB_CABA_VCI_VCACHE_WRAPPER_MULTI_H
...
protected:
    SC_HAS_PROCESS(VciVCacheWrapperMulti);

public:
    VciVCacheWrapperMulti(
