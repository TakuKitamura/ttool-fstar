...
#ifndef SOCLIB_FIFO_SYNCHRONIZATION_H_
#define SOCLIB_FIFO_SYNCHRONIZATION_H_
        ...
        : public soclib::caba::BaseModule
{
	...
	private:
        ...
        enum {
                FIFO_SYNCHRONIZATION_READ,
                FIFO_SYNCHRONIZATION_EXEC,
                FIFO_SYNCHRONIZATION_WAIT,
	...
	public:
	    Synchronization(sc_core::sc_module_name insname, int ncycles);
...
#endif /* SOCLIB_FIFO_SYNCHRONIZATION_H_ */
