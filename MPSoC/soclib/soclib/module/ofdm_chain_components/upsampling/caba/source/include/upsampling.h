...
#ifndef SOCLIB_FIFO_UPSAMPLING_H_
#define SOCLIB_FIFO_UPSAMPLING_H_
        ...
        : public soclib::caba::BaseModule
{
	...
	private:
        ...
        enum {
                FIFO_UPSAMPLING_READ,
                FIFO_UPSAMPLING_EXEC,
                FIFO_UPSAMPLING_WAIT,
	...
	public:
	    Upsampling(sc_core::sc_module_name insname, int ncycles);
...
#endif /* SOCLIB_FIFO_UPSAMPLING_H_ */
