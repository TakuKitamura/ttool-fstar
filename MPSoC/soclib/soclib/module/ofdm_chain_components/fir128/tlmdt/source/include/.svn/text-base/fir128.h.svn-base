...
#ifndef SOCLIB_TLMT_FIR128_H
#define SOCLIB_TLMT_FIR128_H
...
: public sc_core::sc_module
{
 ...
 public:
  std::vector<tlm_utils::simple_target_socket_tagged<Fir128,32,tlm::tlm_base_protocol_types> *> p_config;
  std::vector<tlm_utils::simple_target_socket_tagged<Fir128,32,tlm::tlm_base_protocol_types> *> p_status;

  std::vector<tlm_utils::simple_initiator_socket_tagged<Fir128,32,tlm::tlm_base_protocol_types> *> p_read_fifo;
  std::vector<tlm_utils::simple_initiator_socket_tagged<Fir128,32,tlm::tlm_base_protocol_types> *> p_write_fifo;

  Fir128(sc_core::sc_module_name name,
	      uint32_t id,
