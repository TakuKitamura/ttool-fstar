...
//ajoute DG
    ...
    DEPLOY_RAM13_NAME (RWAL): ORIGIN = DEPLOY_RAM2_ADDR, LENGTH = DEPLOY_RAM13_SIZE
#endif
    ...
    DEPLOY_RAM13_NAME (RWAL): ORIGIN = DEPLOY_RAM14_ADDR, LENGTH = DEPLOY_RAM14_SIZE
#endif
#if defined(CACHED_RAM14_NAME)
    CACHED_RAM4_NAME (RWAL): ORIGIN = CACHED_RAM14_ADDR, LENGTH = CACHED_RAM14_SIZE
#endif
    ...
    CACHED_RAM8_NAME (RWAL): ORIGIN = CACHED_RAM18_ADDR, LENGTH = CACHED_RAM18_SIZE
#endif
    ...
    DEPLOY_RAM23_NAME (RWAL): ORIGIN = DEPLOY_RAM33_ADDR, LENGTH = DEPLOY_RAM23_SIZE
#endif
#if defined(CACHED_RAM23_NAME)
    CACHED_RAM23_NAME (RWAL): ORIGIN = CACHED_RAM23_ADDR, LENGTH = CACHED_RAM32_SIZE
#endif
