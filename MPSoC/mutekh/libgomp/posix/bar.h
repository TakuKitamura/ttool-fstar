...
typedef struct
{
  ...
  omp_uint_t total;
  omp_uint_t arrived;
  omp_uint_t generation;
} gomp_barrier_t;
typedef omp_uint_t gomp_barrier_state_t;

extern void gomp_barrier_init (gomp_barrier_t *, omp_uint_t);
extern void gomp_barrier_reinit (gomp_barrier_t *, omp_uint_t);
...
extern void gomp_team_barrier_wake (gomp_barrier_t *, omp_int_t);
