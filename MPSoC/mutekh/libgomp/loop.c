...
static inline void
gomp_loop_init (struct gomp_work_share *ws, omp_long_t start, omp_long_t end, omp_long_t incr,
		enum gomp_schedule_type sched, omp_long_t chunk_size)
{
  ws->sched = sched;
  ...
  if (sched == GFS_DYNAMIC)
	...
	omp_long_t nthreads = team ? team->nthreads : 1;

	if (__builtin_expect (incr > 0, 1))
	  {
	    /* Cheap overflow protection.  */
	    if (__builtin_expect ((nthreads | ws->chunk_size)
				  >= 1UL << (sizeof (omp_long_t)
					     * __CHAR_BIT__ / 2 - 1), 0))
	      ws->mode = 0;
	    else
...
static bool
gomp_loop_static_start (omp_long_t start, omp_long_t end, omp_long_t incr, omp_long_t chunk_size,
			omp_long_t *istart, omp_long_t *iend)
{
  struct gomp_thread *thr = gomp_thread ();
...
static bool
gomp_loop_dynamic_start (omp_long_t start, omp_long_t end, omp_long_t incr, omp_long_t chunk_size,
			 omp_long_t *istart, omp_long_t *iend)
{
  struct gomp_thread *thr = gomp_thread ();
  bool ret;
...
static bool
gomp_loop_guided_start (omp_long_t start, omp_long_t end, omp_long_t incr, omp_long_t chunk_size,
			omp_long_t *istart, omp_long_t *iend)
{
  struct gomp_thread *thr = gomp_thread ();
  bool ret;
...
bool
GOMP_loop_runtime_start (omp_long_t start, omp_long_t end, omp_long_t incr,
			 omp_long_t *istart, omp_long_t *iend)
{
...
static bool
gomp_loop_ordered_static_start (omp_long_t start, omp_long_t end, omp_long_t incr,
				omp_long_t chunk_size, omp_long_t *istart, omp_long_t *iend)
{
  struct gomp_thread *thr = gomp_thread ();
...
static bool
gomp_loop_ordered_dynamic_start (omp_long_t start, omp_long_t end, omp_long_t incr,
				 omp_long_t chunk_size, omp_long_t *istart, omp_long_t *iend)
{
  struct gomp_thread *thr = gomp_thread ();
  bool ret;
...
static bool
gomp_loop_ordered_guided_start (omp_long_t start, omp_long_t end, omp_long_t incr,
				omp_long_t chunk_size, omp_long_t *istart, omp_long_t *iend)
{
  struct gomp_thread *thr = gomp_thread ();
  bool ret;
...
bool
GOMP_loop_ordered_runtime_start (omp_long_t start, omp_long_t end, omp_long_t incr,
				 omp_long_t *istart, omp_long_t *iend)
{
  struct gomp_task_icv *icv = gomp_icv (false);
  switch (icv->run_sched_var)
...
static bool
gomp_loop_static_next (omp_long_t *istart, omp_long_t *iend)
{
  return !gomp_iter_static_next (istart, iend);
}

static bool
gomp_loop_dynamic_next (omp_long_t *istart, omp_long_t *iend)
{
  bool ret;
...
static bool
gomp_loop_guided_next (omp_long_t *istart, omp_long_t *iend)
{
  bool ret;
...
bool
GOMP_loop_runtime_next (omp_long_t *istart, omp_long_t *iend)
{
  struct gomp_thread *thr = gomp_thread ();
...
static bool
gomp_loop_ordered_static_next (omp_long_t *istart, omp_long_t *iend)
{
  struct gomp_thread *thr = gomp_thread ();
  omp_int_t test;
...
static bool
gomp_loop_ordered_dynamic_next (omp_long_t *istart, omp_long_t *iend)
{
  struct gomp_thread *thr = gomp_thread ();
  bool ret;
...
static bool
gomp_loop_ordered_guided_next (omp_long_t *istart, omp_long_t *iend)
{
  struct gomp_thread *thr = gomp_thread ();
  bool ret;
...
bool
GOMP_loop_ordered_runtime_next (omp_long_t *istart, omp_long_t *iend)
{
  struct gomp_thread *thr = gomp_thread ();
...
gomp_parallel_loop_start (void (*fn) (void *), void *data,
			  omp_uint_t num_threads, omp_long_t start, omp_long_t end,
			  omp_long_t incr, enum gomp_schedule_type sched,
...
GOMP_parallel_loop_static_start (void (*fn) (void *), void *data,
				 omp_uint_t num_threads, omp_long_t start, omp_long_t end,
				 omp_long_t incr, omp_long_t chunk_size)
{
