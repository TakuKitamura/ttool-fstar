...
CONTEXT_LOCAL struct gomp_thread gomp_tls_data;
...
gomp_thread_start (void *xdata)
{
  ...
  thr = CONTEXT_LOCAL_ADDR(gomp_tls_data);
...
struct gomp_team *
gomp_new_team (omp_uint_t nthreads)
{
...
void
gomp_team_start (void (*fn) (void *), void *data, omp_uint_t nthreads,
		 struct gomp_team *team)
{
  ...
  bool nested;
  struct gomp_thread_pool *pool;
  omp_uint_t i, n, old_threads_used = 0;
  ...
  if (__builtin_expect (nthreads > old_threads_used, 0))
    {
      omp_long_t diff = (omp_long_t) nthreads - (omp_long_t) old_threads_used;
