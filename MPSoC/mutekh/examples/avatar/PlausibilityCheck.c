...
void PlausibilityCheck__getNodeListAndPosition(int currentPosition, int list__id0, int list__id1, int list__id2, int list__position0, int list__position1, int list__position2) {
  ...
  traceFunctionCall("PlausibilityCheck", "getNodeListAndPosition", my__attr);
}
...
void *mainFunc__PlausibilityCheck(struct mwmr_s *channels_PlausibilityCheck[]){
  ...
  while(__currentState != STATE__STOP__STATE) {
    switch(__currentState) {
      ...
      if (position>currentPosition) {
        makeNewRequest(&__req1, 730, IMMEDIATE, 0, 0, 0, 0, __params1);
      ...
      if (!((list__id0 == id)||(list__id1 == id)||(list__id2 == id))) {
        makeNewRequest(&__req0, 683, IMMEDIATE, 0, 0, 0, 0, __params0);
        addRequestToList(&__list, &__req0);
      }
      if ((list__id0 == id)||(list__id1 == id)||(list__id2 == id)) {
        makeNewRequest(&__req1, 704, IMMEDIATE, 0, 0, 0, 0, __params1);
        addRequestToList(&__list, &__req1);
      }
      if (nbOfRequests(&__list) == 0) {
        debug2Msg(__myname, "No possible request");
      ...
      makeNewRequest(&__req0, 670, SEND_SYNC_REQUEST, 0, 0, 0, 3, __params0);
      ...
      if (!(speed<3)) {
        makeNewRequest(&__req0, 685, IMMEDIATE, 0, 0, 0, 0, __params0);
        addRequestToList(&__list, &__req0);
      }
      if (speed<3) {
        makeNewRequest(&__req1, 686, IMMEDIATE, 0, 0, 0, 0, __params1);
        addRequestToList(&__list, &__req1);
      }
      if (nbOfRequests(&__list) == 0) {
        debug2Msg(__myname, "No possible request");
      ...
      if (obstacle>0) {
        makeNewRequest(&__req0, 689, IMMEDIATE, 0, 0, 0, 0, __params0);
        addRequestToList(&__list, &__req0);
      }
      if (obstacle == 0) {
        makeNewRequest(&__req1, 695, IMMEDIATE, 0, 0, 0, 0, __params1);
        addRequestToList(&__list, &__req1);
      }
      if (nbOfRequests(&__list) == 0) {
        debug2Msg(__myname, "No possible request");
      ...
      makeNewRequest(&__req0, 678, RECEIVE_SYNC_REQUEST, 0, 0, 0, 2, __params0);
      ...
      traceRequest(__myname, __returnRequest);
      __params0[0] = &speed;
      makeNewRequest(&__req0, 677, RECEIVE_SYNC_REQUEST, 0, 0, 0, 1, __params0);
      ...
      __params0[1] = &list__id0;
      __params0[2] = &list__id1;
      __params0[3] = &list__id2;
      __params0[4] = &list__position0;
      __params0[5] = &list__position1;
      __params0[6] = &list__position2;
      makeNewRequest(&__req0, 668, RECEIVE_SYNC_REQUEST, 0, 0, 0, 7, __params0);
