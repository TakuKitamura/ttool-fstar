...
void *mainFunc__RadarSensor(struct mwmr_s *channels_RadarSensor[]){
  ...
  while(__currentState != STATE__STOP__STATE) {
    switch(__currentState) {
      ...
      makeNewRequest(&__req0, 290, SEND_SYNC_REQUEST, 0, 0, 0, 1, __params0);
      ...
      makeNewRequest(&__req0, 293, IMMEDIATE, 0, 0, 0, 0, __params0);
      addRequestToList(&__list, &__req0);
      makeNewRequest(&__req1, 300, IMMEDIATE, 0, 0, 0, 0, __params1);
      ...
      waitFor((minRadarUpdate)*1000000, (maxRadarUpdate)*1000000);
