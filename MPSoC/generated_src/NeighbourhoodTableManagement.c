  ...
  while(__currentState != STATE__STOP__STATE) {
    switch(__currentState) {
      ...
      if (!(listOfNodes__id1 == id)) {
        makeNewRequest(&__req0, 454, IMMEDIATE, 0, 0, 0, 0, __params0);
        addRequestToList(&__list, &__req0);
      }
      if (listOfNodes__id1 == id) {
        makeNewRequest(&__req1, 555, IMMEDIATE, 0, 0, 0, 0, __params1);
      ...
      if ((listOfNodes__position2<currentPosition)) {
        makeNewRequest(&__req0, 407, IMMEDIATE, 0, 0, 0, 0, __params0);
        addRequestToList(&__list, &__req0);
      }
      if ((listOfNodes__position1<currentPosition)) {
        makeNewRequest(&__req1, 415, IMMEDIATE, 0, 0, 0, 0, __params1);
        addRequestToList(&__list, &__req1);
      }
      if ((listOfNodes__position0<currentPosition)) {
        makeNewRequest(&__req2, 423, IMMEDIATE, 0, 0, 0, 0, __params2);
        addRequestToList(&__list, &__req2);
      }
      if (nbOfRequests(&__list) == 0) {
        debug2Msg(__myname, "No possible request");
      ...
      if (listOfNodes__id0 == id) {
        makeNewRequest(&__req0, 457, IMMEDIATE, 0, 0, 0, 0, __params0);
        addRequestToList(&__list, &__req0);
      }
      if (!(listOfNodes__id0 == id)) {
        makeNewRequest(&__req1, 561, IMMEDIATE, 0, 0, 0, 0, __params1);
        addRequestToList(&__list, &__req1);
      }
      if (nbOfRequests(&__list) == 0) {
        debug2Msg(__myname, "No possible request");
      ...
      if (!((listOfNodes__id0 == id)||(listOfNodes__id1 == id)||(listOfNodes__id2 == id))) {
        makeNewRequest(&__req0, 463, IMMEDIATE, 0, 0, 0, 0, __params0);
        addRequestToList(&__list, &__req0);
      }
      if ((listOfNodes__id0 == id)||(listOfNodes__id1 == id)||(listOfNodes__id2 == id)) {
        makeNewRequest(&__req1, 528, IMMEDIATE, 0, 0, 0, 0, __params1);
        addRequestToList(&__list, &__req1);
      }
      if (nbOfRequests(&__list) == 0) {
        debug2Msg(__myname, "No possible request");
      ...
      if (!((listOfNodes__position0<currentPosition)||(listOfNodes__position1<currentPosition)||(listOfNodes__position2<currentPosition))) {
        makeNewRequest(&__req0, 431, IMMEDIATE, 0, 0, 0, 0, __params0);
        addRequestToList(&__list, &__req0);
      }
      if ((listOfNodes__position0<currentPosition)||(listOfNodes__position1<currentPosition)||(listOfNodes__position2<currentPosition)) {
        makeNewRequest(&__req1, 502, IMMEDIATE, 0, 0, 0, 0, __params1);
        addRequestToList(&__list, &__req1);
      }
      if (nbOfRequests(&__list) == 0) {
        debug2Msg(__myname, "No possible request");
      ...
      if (listOfNodes__id1 == 0) {
        makeNewRequest(&__req1, 439, IMMEDIATE, 0, 0, 0, 0, __params1);
        addRequestToList(&__list, &__req1);
      }
      if (listOfNodes__id0 == 0) {
        makeNewRequest(&__req2, 446, IMMEDIATE, 0, 0, 0, 0, __params2);
        addRequestToList(&__list, &__req2);
      }
      if (nbOfRequests(&__list) == 0) {
        debug2Msg(__myname, "No possible request");
      ...
      if (!((listOfNodes__id0>0)&&(listOfNodes__id1>0)&&(listOfNodes__id2>0))) {
        makeNewRequest(&__req0, 466, IMMEDIATE, 0, 0, 0, 0, __params0);
        addRequestToList(&__list, &__req0);
      }
      if ((listOfNodes__id0>0)&&(listOfNodes__id1>0)&&(listOfNodes__id2>0)) {
        makeNewRequest(&__req1, 476, IMMEDIATE, 0, 0, 0, 0, __params1);
        addRequestToList(&__list, &__req1);
      }
      if (nbOfRequests(&__list) == 0) {
        debug2Msg(__myname, "No possible request");
      ...
      makeNewRequest(&__req0, 344, RECEIVE_SYNC_REQUEST, 0, 0, 0, 1, __params0);
      __req0.syncChannel = &__GPSSensor_setPosition__NeighbourhoodTableManagement_setPosition;
      addRequestToList(&__list, &__req0);
      __params1[0] = &id;
      __params1[1] = &position;
      makeNewRequest(&__req1, 349, RECEIVE_SYNC_REQUEST, 0, 0, 0, 2, __params1);
      ...
      makeNewRequest(&__req2, 336, SEND_SYNC_REQUEST, 0, 0, 0, 7, __params2);
