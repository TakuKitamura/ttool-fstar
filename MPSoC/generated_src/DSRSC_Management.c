...
void *mainFunc__DSRSC_Management(struct mwmr_s *channels_DSRSC_Management[]){
  ...
  while(__currentState != STATE__STOP__STATE) {
    switch(__currentState) {
      ...
      makeNewRequest(&__req0, 563, RECEIVE_SYNC_REQUEST, 0, 0, 0, 2, __params0);
      ...
      makeNewRequest(&__req1, 566, RECEIVE_SYNC_REQUEST, 0, 0, 0, 2, __params1);
      ...
      makeNewRequest(&__req2, 564, RECEIVE_SYNC_REQUEST, 0, 0, 0, 2, __params2);
      ...
      traceRequest(__myname, __returnRequest);
       if (__returnRequest == &__req0) {
        ...
        __params0[0] = &id;
        __params0[1] = &position;
        makeNewRequest(&__req0, 565, SEND_SYNC_REQUEST, 0, 0, 0, 2, __params0);
        ...
        __params0[0] = &id;
        __params0[1] = &position;
        makeNewRequest(&__req0, 562, SEND_SYNC_REQUEST, 0, 0, 0, 2, __params0);
