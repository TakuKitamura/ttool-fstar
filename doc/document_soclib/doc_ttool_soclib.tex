...
\frame[containsverbatim]{
\MyLogo
\frametitle{Requirements for Linux and MacOSX (2)}
...
%\frame[containsverbatim]{
%\MyLogo
%\frametitle{Virtual Box}
%\begin{itemize}
%\item For those who require a ready-to-run version
%and those who do not use Linux,
%we propose a Virtual Machine
%\item The user is ttool and the password is ttoolVM

%\item You have to add in your .bashrc
%\begin{verbatim}
%export SYSTEMC=/opt/systemc-2.3.1
%export PATH=/opt/java/bin:$SYSTEMC/bin:/Prog/mutekh/bin:/opt/mutekh/bin:/home/ttool/Prog/soclib/utils/bin:$PATH

%export LD_LIBRARY_PATH=/opt/mutekh/lib/:$SYSTEMC/lib-linux64:$LD_LIBRARY_PATH
%\end{verbatim}
%\end{itemize}
%}
