...
\caption{Design of a security protocol} \label{fig:fv3}
\end{figure*}

\begin{figure*}[htbp]
\centering
\includegraphics[width=0.2\textwidth]{build/design_t1-svg.pdf}
\includegraphics[width=0.2\textwidth]{build/design_t2-svg.pdf}
\caption{State machines of T1 (on the left) and T2 (on the right)} \label{fig:fv3}
\end{figure*}
