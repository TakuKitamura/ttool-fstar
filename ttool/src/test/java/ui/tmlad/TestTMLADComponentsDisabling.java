...
public class TestTMLADComponentsDisabling extends AbstractUITest {
    ...
    public void testDisableTGConnectorTMLAD() {
        ...
        final TGComponent con1 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
        ...
        final TGComponent con2 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
        ...
        final TGComponent con3 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
    ...
    public void testDisableTMLADForEverLoop() {
        ...
        final TGComponent con2 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                forLoop.getInsideLoopConnectingPoint(), requestInLoop.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(con2, con2.getX(), con2.getY(), false, true);
        ...
        final TGComponent con3 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                requestInLoop.getTGConnectingPointAtIndex(1), stopElementInLoop.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(con3, con3.getX(), con3.getY(), false, true);
    ...
    public void testDisableTMLADForLoop() {
        ...
        final TGComponent con4 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                forLoop.getExitLoopConnectingPoint(), requestExitLoop.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(con4, con4.getX(), con4.getY(), false, true);

        final TGComponent stopElementExitLoop = new TMLADStopState(500, 500, 0, 1400, 0, 1900, true, null,
                diagramPanel);
        diagramPanel.addComponent(stopElementExitLoop, stopElementExitLoop.getX(), stopElementExitLoop.getY(), false,
                true);

        final TGComponent con5 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                requestExitLoop.getTGConnectingPointAtIndex(1), stopElementExitLoop.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
    ...
    public void testDisableTMLADSequence() {
        ...
        final TGComponent con1 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                startElement.getTGConnectingPointAtIndex(0), sequence.getEnterConnectingPoint(), new Vector<Point>());
        diagramPanel.addComponent(con1, con1.getX(), con1.getY(), false, true);
        ...
        final TGComponent con2 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                sequence.getExitConnectingPoints().get(0), requestBranch1.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(con2, con2.getX(), con2.getY(), false, true);
        ...
        final TGComponent con3 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                requestBranch1.getTGConnectingPointAtIndex(1), stopElementBranch1.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(con3, con3.getX(), con3.getY(), false, true);
        ...
        final TGComponent con4 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                sequence.getExitConnectingPoints().get(1), requestBranch2.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(con4, con4.getX(), con4.getY(), false, true);
        ...
        final TGComponent con5 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                requestBranch2.getTGConnectingPointAtIndex(1), stopElementBranch2.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(con5, con5.getX(), con5.getY(), false, true);
        ...
        final TGComponent con6 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                sequence.getExitConnectingPoints().get(2), requestBranch3.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        final TGComponent con7 = new TGConnectorTMLAD(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                requestBranch3.getTGConnectingPointAtIndex(1), stopElementBranch3.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
    ...
    public void testDisableTMLADUnorderedSequence() {
        ...
        final TMLADUnorderedSequence sequence = new TMLADUnorderedSequence(500, 500, 0, 1400, 0, 1900, true, null,
                diagramPanel);
        diagramPanel.addComponent(sequence, sequence.getX(), sequence.getY(), false, true);
