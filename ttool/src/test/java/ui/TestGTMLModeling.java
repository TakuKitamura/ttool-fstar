...
public class TestGTMLModeling extends AbstractUITest {
  ...
  private String translateToTMLModelingXMLZigBeeTutorial(final String diagramName) throws MalformedTMLDesignException {
  ...
  protected void testTranslateToTMLModelingDisable(final String modelName, final String tabName, final String taskName,
      final String testName, final int... compoIds) throws MalformedTMLDesignException {
    openModel(modelName);
    ...
    for (final int compoId : compoIds) {
      ...
      if (compoToDisable == null) {
        ...
        for (TGComponent tgc : activityDiagramPanel.getComponentList()) {
          System.out
              .println("\t\tFAILED comp:" + tgc.getName() + " id=" + tgc.getId() + " UUID=" + tgc.getUUID().toString());
        }
      }
