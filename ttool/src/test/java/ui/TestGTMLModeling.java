...
public class TestGTMLModeling extends AbstractUITest {
    ...
    private TMLModeling<TGComponent> translateToTMLModeling(final String tabName) throws MalformedTMLDesignException {
        ...
        if (!gtmlm.getCheckingErrors().isEmpty()) {
            throw new MalformedTMLDesignException("Errors were found when generating TML model.",
                    gtmlm.getCheckingErrors());
        }
    ...
    private TMLMapping<TGComponent> translateToTMLMapping(final String diagramName) throws MalformedTMLDesignException {
    ...
    private String translateToTMLMappingXMLZigBeeTutorial(final String diagramName) throws MalformedTMLDesignException {
        openModel(MODEL_ZIGBEE_TUTORIAL);
    ...
    @Test
    public void testTranslateToTMLModelingZigbeeTX() throws MalformedTMLDesignException {
    ...
    @Test
    public void testTranslateToTMLMappingMapping0() throws MalformedTMLDesignException {
    ...
    protected void testTranslateToTMLModelingDisable(final String modelName, final String tabName,
            final String taskName, final String testName, final int... compoIds) throws MalformedTMLDesignException {
        openModel(modelName);
        ...
        for (final int compoId : compoIds) {
            ...
            if (compoToDisable == null) {
                ...
                for (TGComponent tgc : activityDiagramPanel.getComponentList()) {
                    System.out.println("\t\tFAILED comp:" + tgc.getName() + " id=" + tgc.getId() + " UUID="
                            + tgc.getUUID().toString());
                }
            }
        ...
        // checkResultXml(task.getActivityDiagram().toXML(), "components_disabling/" +
        // taskName + "_Disable_" + testName);
    }

    protected void testTranslateToTMLModelingDisableZigBeeTutorial(final String taskName, final String testName,
            final int... compoIds) throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisable(MODEL_ZIGBEE_TUTORIAL, DIAG_ZIGBEE_TX, taskName, testName, compoIds);
    }

    protected void testTranslateToTMLModelingDisableSmartCardProtocol(final String taskName, final String testName,
            final int... compoIds) throws MalformedTMLDesignException {
    ...
    @Test
    public void testTranslateToTMLModelingDisableActionState() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial(DIAG_F_SOURCE, "ActionState", 925);
    }

    @Test
    public void testTranslateToTMLModelingDisableSendRequest() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial(DIAG_F_SOURCE, "SendRequest", 922);
    }

    @Test
    public void testTranslateToTMLModelingSendEvent() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial(DIAG_F_SOURCE, "SendEvent", 919);
    }

    @Test
    public void testTranslateToTMLModelingDisableExecC() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial("X_Chip2Octet", "ExecC", 1009);
    }

    @Test
    public void testTranslateToTMLModelingDisableExecI() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial(DIAG_X_SOURCE, "ExecI", 935);
    }

    @Test
    public void testTranslateToTMLModelingDisableReadRequestArg() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial(DIAG_X_SOURCE, "ReadRequestArg", 943);
    }

    @Test
    public void testTranslateToTMLModelingDisableWriteChannel() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial(DIAG_X_SOURCE, "WriteChannel", 940);
    }

    @Test
    public void testTranslateToTMLModelingDisableWaitEvent() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial("F_Symbol2ChipSeq", "WaitEvent", 952);
    }

    @Test
    public void testTranslateToTMLModelingDisableReadChannel() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial("X_Symbol2ChipSeq", "ReadChannel", 973);
    }

    @Test
    public void testTranslateToTMLModelingDisableActionStateSendRequest() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial(DIAG_F_SOURCE, "ActionStateSendRequest",
                new int[] { 925, 922 });
    }

    @Test
    public void testTranslateToTMLModelingDisableForLoop() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableSmartCardProtocol("InterfaceDevice", "ForLoop", 1285);
    }

    @Test
    public void testTranslateToTMLModelingDisableForLoopAfterStart() throws MalformedTMLDesignException {
    ...
    public void testTranslateToTMLModelingDisableChoiceLeft() {
        try {
            ...
            assertTrue(
                    "TML modeling translation did not generate the expected '"
                            + UICheckingError.MESSAGE_CHOICE_BOTH_STOCHASTIC_DETERMINISTIC + "' error!",
                    ex.getErrors().size() == 1);

            assertEquals(UICheckingError.MESSAGE_CHOICE_BOTH_STOCHASTIC_DETERMINISTIC,
                    ex.getErrors().get(0).toString());
        }
    }

    @Test
    public void testTranslateToTMLModelingDisableChoiceLeftBottom() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableSmartCardProtocol("TCPIP", "ChoiceLeftBottom", 1060, 1063);
    }

    @Test
    public void testTranslateToTMLModelingDisableChoiceLeftBottomRight() throws MalformedTMLDesignException {
    ...
    @Test
    public void testTranslateToTMLModelingDisableConnector() throws MalformedTMLDesignException {
    ...
    @Test
    public void testTranslateToTMLModelingDisableActionStateSendEvent() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial(DIAG_F_SOURCE, "ActionStateSendEvent", new int[] { 925, 919 });
    }

    @Test
    public void testTranslateToTMLModelingDisableSendRequestSendEvent() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial(DIAG_F_SOURCE, "SendRequestSendEvent", new int[] { 922, 919 });
    }

    @Test
    public void testTranslateToTMLModelingDisableActionStateSendRequestSendEvent() throws MalformedTMLDesignException {
        testTranslateToTMLModelingDisableZigBeeTutorial(DIAG_F_SOURCE, "ActionStateSendRequestSendEvent",
                new int[] { 925, 922, 919 });
    }
}
