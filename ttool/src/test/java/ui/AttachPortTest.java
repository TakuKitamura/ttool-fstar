        ...
        if (diagramPanel != null) {
            for (TGComponent tgc : diagramPanel.getAllComponentList()) {
                ...
                if ((tgc instanceof TMLCPrimitivePort)
                        && ((TMLCPrimitivePort) tgc).getPortName().equals("primitivePort1")) {
                    primitivePort1 = (TMLCPrimitivePort) tgc;
                }

                if ((tgc instanceof TMLCPrimitivePort)
                        && ((TMLCPrimitivePort) tgc).getPortName().equals("primitivePort2")) {
                    primitivePort2 = (TMLCPrimitivePort) tgc;
                }

                if ((tgc instanceof TMLCPrimitivePort)
                        && ((TMLCPrimitivePort) tgc).getPortName().equals("primitivePort3")) {
                    primitivePort3 = (TMLCPrimitivePort) tgc;
                }

                if ((tgc instanceof TMLCPrimitivePort)
                        && ((TMLCPrimitivePort) tgc).getPortName().equals("primitivePort4")) {
