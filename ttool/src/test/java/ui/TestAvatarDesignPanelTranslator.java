...
public class TestAvatarDesignPanelTranslator extends AbstractUITest {
    ...
    private void testTranslateStateMachineDiagramToAvatarDisable(final String modelName, final String tabName,
            final String blockName, final String testName, final int... composToDisable)
    ...
    private void testTranslateStateMachineDiagramToAvatarEbookReaderDisable(final String tabName,
            final String blockName, final String testName, final int... composToDisable)
            throws MalformedModelingException {
        testTranslateStateMachineDiagramToAvatarDisable("ebook_reader_01", tabName, blockName, testName,
                composToDisable);
    }
