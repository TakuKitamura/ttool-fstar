...
public class TestAvatarSMDComponentsDisabling extends AbstractUITest {
    ...
    public void testDisableAvatarSMDConnector() {
        ...
        final TGComponent sendSignalElement = new AvatarSMDSendSignal(500, 500, 0, 1400, 0, 1900, true, null,
                diagramPanel);
        diagramPanel.addComponent(sendSignalElement, sendSignalElement.getX(), sendSignalElement.getY(), false, true);

        final AvatarSMDConnector con1 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                startElement.getTGConnectingPointAtIndex(0), sendSignalElement.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        final AvatarSMDConnector con2 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                sendSignalElement.getTGConnectingPointAtIndex(1), randomElement.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        final AvatarSMDConnector con3 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                randomElement.getTGConnectingPointAtIndex(1), stopElement.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
    ...
    public void testDisableAvatarSMDLibraryFunctionCall() {
        final CDElement element = new AvatarSMDLibraryFunctionCall(500, 500, 0, 1400, 0, 1900, true, null,
                diagramPanel);
    ...
    public void testDisableAvatarSMDState() {
        ...
        final TGComponent con1 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                startElement.getTGConnectingPointAtIndex(0), compositeState1.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(con1, con1.getX(), con1.getY(), false, true);

        final TGComponent startElementState1 = new AvatarSMDStartState(500, 500, 0, 1400, 0, 1900, true,
                compositeState1, diagramPanel);
        compositeState1.addInternalComponent(startElementState1, indexState1++);

        final TGComponent timerState11 = new AvatarSMDResetTimer(500, 500, 0, 1400, 0, 1900, true, compositeState1,
                diagramPanel);
        compositeState1.addInternalComponent(timerState11, indexState1++);

        final AvatarSMDConnector conState11 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(),
                diagramPanel.getMaxX(), diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                startElementState1.getTGConnectingPointAtIndex(0), timerState11.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        final AvatarSMDState compositeState2 = new AvatarSMDState(500, 500, 0, 1400, 0, 1900, true, compositeState1,
                diagramPanel);
        compositeState2.setValue(testName);
        int indexState2 = 0;
        compositeState1.addInternalComponent(compositeState2, indexState1++);

        final TGComponent conState12 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                timerState11.getTGConnectingPointAtIndex(1), compositeState2.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(conState12, conState12.getX(), conState12.getY(), false, true);

        final TGComponent startElementState2 = new AvatarSMDStartState(500, 500, 0, 1400, 0, 1900, true,
                compositeState2, diagramPanel);
        compositeState2.addInternalComponent(startElementState2, indexState2++);
        final TGComponent receiveSignalState2 = new AvatarSMDReceiveSignal(500, 500, 0, 1400, 0, 1900, true,
                compositeState2, diagramPanel);
        compositeState2.addInternalComponent(receiveSignalState2, indexState2++);

        final TGComponent conState21 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                startElementState2.getTGConnectingPointAtIndex(0), receiveSignalState2.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(conState21, conState21.getX(), conState21.getY(), false, true);

        final TGComponent timerState12 = new AvatarSMDResetTimer(500, 500, 0, 1400, 0, 1900, true, compositeState1,
                diagramPanel);
        compositeState1.addInternalComponent(timerState12, indexState1++);

        final TGComponent conState13 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                receiveSignalState2.getTGConnectingPointAtIndex(1), timerState12.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        final TGComponent conStateTest = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                timerState12.getTGConnectingPointAtIndex(1), stateTest.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(conStateTest, conStateTest.getX(), conStateTest.getY(), false, true);

        final TGComponent receiveSignal = new AvatarSMDReceiveSignal(500, 500, 0, 1400, 0, 1900, true, null,
                diagramPanel);
        receiveSignal.setValue(testName);
        diagramPanel.addComponent(receiveSignal, receiveSignal.getX(), receiveSignal.getY(), false, true);

        final TGComponent conReceiveSignal = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(),
                diagramPanel.getMaxX(), diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                stateTest.getTGConnectingPointAtIndex(1), receiveSignal.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        final TGComponent conStateTest2 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                receiveSignal.getTGConnectingPointAtIndex(1), stateTest2.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        final TGComponent conSendSignal = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                stateTest2.getTGConnectingPointAtIndex(1), sendSignal.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        final TGComponent conStateTest3 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                sendSignal.getTGConnectingPointAtIndex(1), stateTest3.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        final TGComponent conStop = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                stateTest3.getTGConnectingPointAtIndex(1), stopElement.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
    ...
    public void testDisableAvatarSMDStopState() {
        ...
        final TGComponent con2 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                action.getTGConnectingPointAtIndex(1), stopElement.getTGConnectingPointAtIndex(0), new Vector<Point>());
        diagramPanel.addComponent(con2, con2.getX(), con2.getY(), false, true);
    ...
    public void testDisableAvatarSMDTransitionInfo() {
        ...
        final AvatarSMDConnector con1 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                startElement.getTGConnectingPointAtIndex(0), setTimer.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        final AvatarSMDConnector con2 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                setTimer.getTGConnectingPointAtIndex(1), stopElement.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(con2, con2.getX(), con2.getY(), false, true);
