...
public class TestAvatarSMDComponentsDisabling extends AbstractUITest {
  ...
  public void testDisableAvatarSMDConnector() {
    ...
    final AvatarSMDConnector con3 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
        diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
        randomElement.getTGConnectingPointAtIndex(1), stopElement.getTGConnectingPointAtIndex(0), new Vector<Point>());
  ...
  public void testDisableAvatarSMDState() {
    ...
    final TGComponent startElementState1 = new AvatarSMDStartState(500, 500, 0, 1400, 0, 1900, true, compositeState1,
        diagramPanel);
    ...
    final AvatarSMDConnector conState11 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
        diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
    ...
    final TGComponent startElementState2 = new AvatarSMDStartState(500, 500, 0, 1400, 0, 1900, true, compositeState2,
        diagramPanel);
    ...
    final TGComponent conStateTest = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
        diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
        timerState12.getTGConnectingPointAtIndex(1), stateTest.getTGConnectingPointAtIndex(0), new Vector<Point>());
    ...
    final TGComponent conReceiveSignal = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
        diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
        stateTest.getTGConnectingPointAtIndex(1), receiveSignal.getTGConnectingPointAtIndex(0), new Vector<Point>());
    ...
    final TGComponent conStateTest2 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
        diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
        receiveSignal.getTGConnectingPointAtIndex(1), stateTest2.getTGConnectingPointAtIndex(0), new Vector<Point>());
    ...
    final TGComponent conSendSignal = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
        diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
        stateTest2.getTGConnectingPointAtIndex(1), sendSignal.getTGConnectingPointAtIndex(0), new Vector<Point>());
    ...
    final TGComponent conStateTest3 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
        diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
        sendSignal.getTGConnectingPointAtIndex(1), stateTest3.getTGConnectingPointAtIndex(0), new Vector<Point>());
    ...
    final TGComponent conStop = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
        diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
        stateTest3.getTGConnectingPointAtIndex(1), stopElement.getTGConnectingPointAtIndex(0), new Vector<Point>());
  ...
  public void testDisableAvatarSMDStopState() {
    ...
    final TGComponent con1 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
        diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
        startElement.getTGConnectingPointAtIndex(0), action.getTGConnectingPointAtIndex(0), new Vector<Point>());
    diagramPanel.addComponent(con1, con1.getX(), con1.getY(), false, true);
  ...
  public void testDisableAvatarSMDTransitionInfo() {
    ...
    final AvatarSMDConnector con1 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
        diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
        startElement.getTGConnectingPointAtIndex(0), setTimer.getTGConnectingPointAtIndex(0), new Vector<Point>());
    ...
    final AvatarSMDConnector con2 = new AvatarSMDConnector(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
        diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
        setTimer.getTGConnectingPointAtIndex(1), stopElement.getTGConnectingPointAtIndex(0), new Vector<Point>());
    diagramPanel.addComponent(con2, con2.getX(), con2.getY(), false, true);
