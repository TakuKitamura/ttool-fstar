...
public class DiplodocusDelayTest extends AbstractUITest {
    ...
    final static String EXPECTED_FILE1 = getBaseResourcesDir()
            + "tmltranslator/expected/expected_specdelay_readwrite.tml";
    final static String EXPECTED_FILE2 = getBaseResourcesDir()
            + "tmltranslator/expected/expected_consecutive_delay1.tml";
    final static String EXPECTED_FILE3 = getBaseResourcesDir()
            + "tmltranslator/expected/expected_consecutive_delay2.tml";
    ...
    final String[] MODELS_FPGA_RECONFIG = { "fpga_reconfig1", "fpga_reconfig2", "fpga_reconfig3", "fpga_reconfig4",
    ...
    public void testDelayNoPenalty() throws Exception {
        for (int i = 0; i < MODELS_DELAY.length; i++) {
            ...
            try {
                ...
                // proc = Runtime.getRuntime().exec("./" + SIM_DIR + "run.x -explo -gname
                // testgraph_" + s);
                proc_in = new BufferedReader(new InputStreamReader(proc.getInputStream()));
