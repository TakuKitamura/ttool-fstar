...
public class RemoveAllTransactionsTests extends AbstractUITest {
    ...
    final static String EXPECTED_FILE_REMOVE_ALL_TRANS = getBaseResourcesDir()
            + "tmltranslator/expected/expected_remove_all_trans.txt";
    ...
    public void testRemoveAllTransactions() throws Exception {
        for (int i = 0; i < MODELS_PARSE_HTML.length; i++) {
            ...
            try {
                ...
                params[1] = "-cmd";
                // first remove all transactions when the transacList is empty to see it crash
                // or not
                ...
                params[2] = "26 1;1 6 100; 26 1;22 100; 1 6 100; 7 2 " + graphPath + "_save.txt" + "; 1 0; 1 7 100 100 "
                        + graphPath + "_save";
            ...
            System.out.println(
                    "executing: nb transitions of remove transactions " + s + " " + graph.getNbOfTransitions());
