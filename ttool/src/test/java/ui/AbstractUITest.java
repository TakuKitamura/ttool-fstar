...
public abstract class AbstractUITest extends AbstractTest {
    ...
    protected TDiagramPanel findDiagramPanel(final TDiagramPanel parentPanel, final String diagramName) {
    ...
    protected TGComponent findDiagComponent(final int compoId, final TDiagramPanel diagPanel) {
        return findDiagComponent(compoId, diagPanel.componentList);
    }

    protected TGComponent findDiagComponent(final int compoId, final Collection<TGComponent> components) {
