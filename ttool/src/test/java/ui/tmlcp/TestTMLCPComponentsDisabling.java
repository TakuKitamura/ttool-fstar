...
public class TestTMLCPComponentsDisabling extends AbstractUITest {
    ...
    public void testDisableTGConnectorTMLCP() {
        ...
        final TGComponent con1 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                ...
                startElement.getTGConnectingPointAtIndex(0), refElement1.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        final TGComponent con2 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                refElement1.getTGConnectingPointAtIndex(1), refElement2.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        final TGComponent con3 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                refElement2.getTGConnectingPointAtIndex(1), stopElement.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
    ...
    public void testDisableTMLCPFork() {
        ...
        final TGComponent con2 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                fork.getExitConnectingPoints().get(0), elementBranch1.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(con2, con2.getX(), con2.getY(), false, true);
        ...
        final TGComponent con4 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                fork.getExitConnectingPoints().get(1), elementBranch2.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        ...
        diagramPanel.addComponent(elementJoinBranch23, elementJoinBranch23.getX(), elementJoinBranch23.getY(), false,
                true);
        ...
        final TGComponent con6 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                fork.getExitConnectingPoints().get(2), elementBranch3.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
    ...
    public void testDisableTMLCPForLoop() {
        ...
        final TGComponent con1 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                startElement.getTGConnectingPointAtIndex(0), forLoop.getEnterLoopConnectingPoint(),
                new Vector<Point>());
        diagramPanel.addComponent(con1, con1.getX(), con1.getY(), false, true);
        ...
        final TGComponent con2 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                forLoop.getInsideLoopConnectingPoint(), elementInLoop.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(con2, con2.getX(), con2.getY(), false, true);
        ...
        final TGComponent con4 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                forLoop.getExitLoopConnectingPoint(), elementExitLoop.getTGConnectingPointAtIndex(0),
                new Vector<Point>());
        diagramPanel.addComponent(con4, con4.getX(), con4.getY(), false, true);

        final TGComponent stopElementExitLoop = new TMLCPStopState(500, 500, 0, 1400, 0, 1900, true, null,
                diagramPanel);
        diagramPanel.addComponent(stopElementExitLoop, stopElementExitLoop.getX(), stopElementExitLoop.getY(), false,
                true);
    ...
    public void testDisableTMLCPJoin() {
        final TGComponent startElementBranch1 = new TMLCPStartState(500, 500, 0, 1400, 0, 1900, true, null,
                diagramPanel);
        diagramPanel.addComponent(startElementBranch1, startElementBranch1.getX(), startElementBranch1.getY(), false,
                true);
        ...
        final TGComponent con2 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                elementBranch1.getTGConnectingPointAtIndex(1), join.getEnterConnectingPoints().get(0),
                new Vector<Point>());
        diagramPanel.addComponent(con2, con2.getX(), con2.getY(), false, true);

        final TGComponent startElementBranch2 = new TMLCPStartState(500, 500, 0, 1400, 0, 1900, true, null,
                diagramPanel);
        diagramPanel.addComponent(startElementBranch2, startElementBranch2.getX(), startElementBranch2.getY(), false,
                true);
        ...
        final TGComponent con4 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                elementBranch2.getTGConnectingPointAtIndex(1), join.getEnterConnectingPoints().get(1),
                new Vector<Point>());
        diagramPanel.addComponent(con4, con4.getX(), con4.getY(), false, true);

        final TGComponent startElementBranch3 = new TMLCPStartState(500, 500, 0, 1400, 0, 1900, true, null,
                diagramPanel);
        diagramPanel.addComponent(startElementBranch3, startElementBranch3.getX(), startElementBranch3.getY(), false,
                true);
        ...
        final TGComponent con6 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                elementBranch3.getTGConnectingPointAtIndex(1), join.getEnterConnectingPoints().get(2),
                new Vector<Point>());
        diagramPanel.addComponent(con6, con6.getX(), con6.getY(), false, true);
        ...
        final TGComponent con7 = new TGConnectorTMLCP(0, 0, diagramPanel.getMinX(), diagramPanel.getMaxX(),
                diagramPanel.getMinY(), diagramPanel.getMaxY(), false, null, diagramPanel,
                join.getExitConnectingPoint(), elementBranch3.getTGConnectingPointAtIndex(0), new Vector<Point>());
        diagramPanel.addComponent(con7, con7.getX(), con7.getY(), false, true);

        final TGComponent stopElementBranchExit = new TMLCPStopState(500, 500, 0, 1400, 0, 1900, true, null,
                diagramPanel);
        diagramPanel.addComponent(stopElementBranchExit, stopElementBranchExit.getX(), stopElementBranchExit.getY(),
                false, true);
