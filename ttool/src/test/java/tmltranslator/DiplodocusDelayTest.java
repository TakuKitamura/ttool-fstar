...
public class DiplodocusDelayTest extends AbstractUITest {
    ...
    final String [] MODELS_DELAY = {"mono-RR", "mono-RRPB","multi-RR","multi-RRPB","fpgaTest","delay-idle","rescheduleFPGA"};
    final int [] NB_Of_DELAY_STATES = {42, 42, 42, 42, 32, 32, 15};
    final int [] NB_Of_DELAY_TRANSTIONS = {41, 41, 41, 41, 31, 31, 14};
    final int [] MIN_DELAY_CYCLES = {2020, 2020, 2010, 2010, 2010, 2020, 130};
    final int [] MAX_DELAY_CYCLES = {2020, 2020, 2010, 2010, 2010, 2020, 130};

    //model for Delay task with penalties
    final int [] NB_Of_DELAY_STATES_PENALTIES = {42, 42, 42, 42, 32, 32, 15};
    final int [] NB_Of_DELAY_TRANSTIONS_PENALTIES = {41, 41, 41, 41, 31, 31, 14};
    final int [] MIN_DELAY_CYCLES_PENALTIES = {2590, 2590, 2670, 2670, 2010, 2340, 130};
    final int [] MAX_DELAY_CYCLES_PENALTIES = {2590, 2590, 2670, 2670, 2010, 2340, 130};
