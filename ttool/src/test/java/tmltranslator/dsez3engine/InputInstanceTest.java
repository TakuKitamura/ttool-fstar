...
public class InputInstanceTest {
  ...
  public void getLocalMemoryOfHwExecutionNode() {
    ...
    assertTrue("comparing between the expected local memory for main_CPU and the memory found", inputInstance
        .getLocalMemoryOfHwExecutionNode(inputInstance.getArchitecture().getHwNodeByName("MainCPU")) == output1);
  ...
  public void getWCET() {
    ...
    assertEquals("comparing between the expected WCET of task A on main_CPU and the computed value", expectedWcetA_CPU,
