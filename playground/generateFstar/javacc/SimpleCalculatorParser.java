...
public class SimpleCalculatorParser/*@bgen(jjtree)*/implements SimpleCalculatorParserTreeConstants, SimpleCalculatorParserConstants {/*@bgen(jjtree)*/
  ...
  {
      String generated = transpile("x > 0");
      if (generated != null) {
        System.out.println(generated);
      }
  }

  public static String transpile(String s) {
    ...
    try {
        return (String) parser.Root().jjtAccept(visitor, null);
    } catch (Exception e) {
        e.printStackTrace();
        return null;
    }
 ...
 /*@bgen(jjtree) NullLiteral */
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x80,0x40,0x20,0x10,0x3b44d00,0x3b44900,0x3b44000,0x1800000,};
   }
