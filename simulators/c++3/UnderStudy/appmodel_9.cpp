...
/* A bus ahs been added to link directly th two CPUs and that is used to map the channel. Mapping Phone on BusOVEST is ignored. */

class CurrentComponents: public SimComponents{
    public:
    CurrentComponents():SimComponents(1291809063){
        //Declaration of CPUs
        ...
        addBus(BusSUD_0);
        Bus* Bus0_0 = new Bus(9,"Bus0_0",0, 100, 4, 1,false);
        addBus(Bus0_0);
        ...
        BusMaster* CPU10_Bus0_Master = new BusMaster("CPU10_Bus0_Master", 0, 1, array(1, (SchedulableCommDevice*)Bus0_0));
        CPU10->addBusMaster(CPU10_Bus0_Master);
        ...
        TMLnbrnbwChannel* channel__DIPLODOCUS_C_Design__Phone = new TMLnbrnbwChannel(14,"DIPLODOCUS_C_Design__Phone",4,2,array(2,CPU00_Bus0_Master,CPU10_Bus0_Master),array(2,static_cast<Slave*>(0),static_cast<Slave*>(0)),0);
        ...
        Bus0_0->setScheduler((WorkloadSource*) new RRScheduler("Bus0_RRSched", 0, 5, 1, array(2, (WorkloadSource*)CPU10_Bus0_Master, (WorkloadSource*)CPU00_Bus0_Master), 2));
        
        //Declaration of tasks
        DIPLODOCUS_C_Design__Alice* task__DIPLODOCUS_C_Design__Alice = new DIPLODOCUS_C_Design__Alice(10,0,"DIPLODOCUS_C_Design__Alice", array(1,CPU10),1
        ,channel__DIPLODOCUS_C_Design__Phone
        );
        addTask(task__DIPLODOCUS_C_Design__Alice);
        DIPLODOCUS_C_Design__Bob* task__DIPLODOCUS_C_Design__Bob = new DIPLODOCUS_C_Design__Bob(12,0,"DIPLODOCUS_C_Design__Bob", array(1,CPU00),1
        ,channel__DIPLODOCUS_C_Design__Phone
        );
