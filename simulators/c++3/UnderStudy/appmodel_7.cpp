...
/* Same model as in 6. Removing the mapping of Phone from the bridges does not change the mapping configuration of Phone on the
 * buses. */

class CurrentComponents: public SimComponents{
    public:
    CurrentComponents():SimComponents(619747822){
        //Declaration of CPUs
        ...
        TMLnbrnbwChannel* channel__DIPLODOCUS_C_Design__Phone = new TMLnbrnbwChannel(13,"DIPLODOCUS_C_Design__Phone",4,6,array(6,CPU00_BusNORD_Master,BridgeNORD_BusEST_Master,BridgeSUD_BusSUD_Master,BridgeNORD_BusNORD_Master,BridgeSUD_BusEST_Master,CPU10_BusSUD_Master),array(6,static_cast<Slave*>(BridgeNORD),static_cast<Slave*>(BridgeSUD),static_cast<Slave*>(0),static_cast<Slave*>(0),static_cast<Slave*>(BridgeNORD),static_cast<Slave*>(BridgeSUD)),0);
