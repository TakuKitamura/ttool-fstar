...
/* Mapping is the same as case 4, but channel Phone is mapped to BusNORD. The simulator src code contiunes to ignore this
 * information as Phone appears to be mapped to BusSUD */

class CurrentComponents: public SimComponents{
    public:
    CurrentComponents():SimComponents(500772176){
        //Declaration of CPUs
