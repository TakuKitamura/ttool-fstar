...
/* In this code I have created two routes one EST and one WEST by means of busses and bridges. Phone is mapped to one specific
 * route (mapping to buses and bridges). All this info is taken into account by the simulator src code. */

class CurrentComponents: public SimComponents{
    public:
    CurrentComponents():SimComponents(-469272119){
        //Declaration of CPUs
        ...
        TMLnbrnbwChannel* channel__DIPLODOCUS_C_Design__Phone = new TMLnbrnbwChannel(
				13,
				"DIPLODOCUS_C_Design__Phone",
				4,
				6,
				array(6,CPU00_BusNORD_Master,BridgeNORD_BusEST_Master,BridgeSUD_BusSUD_Master,BridgeNORD_BusNORD_Master,BridgeSUD_BusEST_Master,CPU10_BusSUD_Master),
				array(6,static_cast<Slave*>(BridgeNORD),
				static_cast<Slave*>(BridgeSUD),
				static_cast<Slave*>(0),
				static_cast<Slave*>(0),
				static_cast<Slave*>(BridgeNORD),
				static_cast<Slave*>(BridgeSUD)),0);
