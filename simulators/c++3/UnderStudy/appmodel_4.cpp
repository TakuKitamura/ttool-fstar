...
/* Now memory has been attached to BusNORD and channel Phone is always mapped to Memory0. Consequently to this mapping, channel
 * Phone is NOW mapped to BusNORD */

class CurrentComponents: public SimComponents{
    public:
    CurrentComponents():SimComponents(1996977938){
        //Declaration of CPUs
        ...
        TMLnbrnbwChannel* channel__DIPLODOCUS_C_Design__Phone = new TMLnbrnbwChannel(10,"DIPLODOCUS_C_Design__Phone",4,2,array(2,CPU00_BusNORD_Master,CPU10_BusNORD_Master),array(2,static_cast<Slave*>(Memory0),static_cast<Slave*>(Memory0)),0);
