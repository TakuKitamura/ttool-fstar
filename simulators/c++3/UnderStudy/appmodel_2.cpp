...
/* In the corresponding model, channel Phone has been mapped to BusNord but the simulator source code ignores this mapping! */

class CurrentComponents: public SimComponents{
    public:
    CurrentComponents():SimComponents(1928487690){
        //Declaration of CPUs
        ...
        TMLnbrnbwChannel* channel__DIPLODOCUS_C_Design__Phone = new TMLnbrnbwChannel(9,"DIPLODOCUS_C_Design__Phone",4,2,array(2,CPU00_BusSUD_Master,CPU10_BusSUD_Master),array(2,static_cast<Slave*>(0),static_cast<Slave*>(0)),0);
