...
class AppC__Timer: public TMLTask {
    ...
    TMLNotifiedCommand _notified251;
    TMLSendCommand _send248;
    TMLWaitCommand _wait249;
    TMLStopCommand _stop246;
    TMLRandomChoiceCommand _choice246;
    
    unsigned int _choice246_func(ParamType& oMin, ParamType& oMax);
