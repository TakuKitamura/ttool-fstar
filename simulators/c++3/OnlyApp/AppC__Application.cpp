...
,_waitOnRequest(96,this,requestChannel,0,"\xdc\x0\x0\x0",false)
,_send98(98,this,event__AppC__open__AppC__open,0,"\xdc\x0\x0\x0",true)
,_write99(99,this,0,channel__AppC__fromAtoT,"\xdc\x0\x0\x0",true,1)
,_send100(100,this,event__AppC__send_TCP__AppC__send_TCP,0,"\xdc\x0\x0\x0",true)
,_send103(103,this,event__AppC__close__AppC__close,0,"\xdc\x0\x0\x0",true)
,_send102(102,this,event__AppC__abort__AppC__abort,0,"\xdc\x0\x0\x0",true)
,_choice97(97,this,(RangeFuncPointer)&AppC__Application::_choice97_func,2,"\xdc\x0\x0\x0",false)

{
    ...
    //command chaining
    _send103.setNextCommand(array(1,(TMLCommand*)&_waitOnRequest));
    _send102.setNextCommand(array(1,(TMLCommand*)&_waitOnRequest));
    _choice97.setNextCommand(array(2,(TMLCommand*)&_send103,(TMLCommand*)&_send102));
    _send100.setNextCommand(array(1,(TMLCommand*)&_choice97));
    _write99.setNextCommand(array(1,(TMLCommand*)&_send100));
    _send98.setNextCommand(array(1,(TMLCommand*)&_write99));
    _waitOnRequest.setNextCommand(array(1,(TMLCommand*)&_send98));
...
unsigned int AppC__Application::_choice97_func(ParamType& oMin, ParamType& oMax){
    oMin=0;
    oMax=1;
    return myrand(0, 1);
