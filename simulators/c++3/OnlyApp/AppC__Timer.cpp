...
,x(0)
,_waitOnRequest(245,this,requestChannel,0,"\xe\x0\x0\x0",false)
,_notified251(251,this,event__AppC__stop__AppC__stop,&x,"x","\xf\x0\x0\x0",false)
,_send248(248,this,event__AppC__timeOut__AppC__timeOut,0,"\xe\x0\x0\x0",true)
,_wait249(249,this,event__AppC__stop__AppC__stop,0,"\xe\x0\x0\x0",true)
, _stop246(246,this)
,_choice246(246,this,(RangeFuncPointer)&AppC__Timer::_choice246_func,3,"\xe\x0\x0\x0",false)

{
    ...
    //command chaining
    _send248.setNextCommand(array(1,(TMLCommand*)&_waitOnRequest));
    _wait249.setNextCommand(array(1,(TMLCommand*)&_waitOnRequest));
    _choice246.setNextCommand(array(3,(TMLCommand*)&_send248,(TMLCommand*)&_wait249,(TMLCommand*)&_stop246));
    _notified251.setNextCommand(array(1,(TMLCommand*)&_choice246));
    _waitOnRequest.setNextCommand(array(1,(TMLCommand*)&_notified251));
...
unsigned int AppC__Timer::_choice246_func(ParamType& oMin, ParamType& oMax){
    unsigned int oC=0;
    oMin=-1;
    oMax=0;
    if ( x==0 ){
