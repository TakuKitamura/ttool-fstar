...
,tcpctrl__a(0)
,tcpctrl__state(0)
,_waitOnRequest(76,this,requestChannel,0,"\x0\xf9\x1f\x0",false)
,_wait77(77,this,event__AppC__reset__AppC__reset,0,"\x0\xf9\x1f\x0",false)
,_send78(78,this,event__AppC__answerToReset__AppC__answerToReset,0,"\x0\xf9\x1f\x0",false)
,_wait79(79,this,event__AppC__pTS__AppC__pTS,0,"\x0\xf9\x1f\x0",false)
,_send80(80,this,event__AppC__pTSConfirm__AppC__pTSConfirm,0,"\x0\xf9\x1f\x0",false)
,_request81(81,this,request__AppC__start_TCP_IP,0,"\x0\xf9\x1f\x0",false)
,_request82(82,this,request__AppC__start_Application,0,"\x0\xf9\x1f\x0",false)
,_lpIncAc93(93,this,(ActionFuncPointer)&AppC__SmartCard::_lpIncAc93_func, 0, false)
,_read86(86,this,0,channel__AppC__fromTtoP,"\x10\xf9\x1f\x0",true,1)
,_send84(84,this,event__AppC__data_Ready_SC__AppC__data_Ready_SC,0,"\x10\xf9\x1f\x0",true)
,_write88(88,this,0,channel__AppC__fromSCtoD,"\x10\xf9\x1f\x0",true,1)
,_read90(90,this,0,channel__AppC__fromDtoSC__AppC__fromDtoSC0,"\x10\xf9\x1f\x0",true,1)
,_send89(89,this,event__AppC__receive__AppC__receive,0,"\x10\xf9\x1f\x0",true)
,_write91(91,this,0,channel__AppC__fromPtoT,"\x10\xf9\x1f\x0",true,1)
,_select95(95,this,array(2,(TMLEventChannel*)event__AppC__send__AppC__send,(TMLEventChannel*)event__AppC__data_Ready__AppC__data_Ready),2,"\x10\xf9\x1f\x0",false,array(2,(ParamFuncPointer)0,(ParamFuncPointer)0))
,_lpChoice93(93,this,(RangeFuncPointer)&AppC__SmartCard::_lpChoice93_func,2,0, false)
...

{
    ...
    _varLookUpID[15]=&tcpctrl__a;
    _varLookUpName["tcpctrl__state"]=&tcpctrl__state;
    _varLookUpID[16]=&tcpctrl__state;
    ...
    //command chaining
    _lpIncAc93.setNextCommand(array(1,(TMLCommand*)&_lpChoice93));
    _write88.setNextCommand(array(1,(TMLCommand*)&_lpIncAc93));
    _send84.setNextCommand(array(1,(TMLCommand*)&_write88));
    _read86.setNextCommand(array(1,(TMLCommand*)&_send84));
    _write91.setNextCommand(array(1,(TMLCommand*)&_lpIncAc93));
    _send89.setNextCommand(array(1,(TMLCommand*)&_write91));
    _read90.setNextCommand(array(1,(TMLCommand*)&_send89));
    _select95.setNextCommand(array(2,(TMLCommand*)&_read86,(TMLCommand*)&_read90));
    _lpChoice93.setNextCommand(array(2,(TMLCommand*)&_select95,(TMLCommand*)&_waitOnRequest));
    _action259.setNextCommand(array(1,(TMLCommand*)&_lpChoice93));
    _request82.setNextCommand(array(1,(TMLCommand*)&_action259));
    _request81.setNextCommand(array(1,(TMLCommand*)&_request82));
    _send80.setNextCommand(array(1,(TMLCommand*)&_request81));
    _wait79.setNextCommand(array(1,(TMLCommand*)&_send80));
    _send78.setNextCommand(array(1,(TMLCommand*)&_wait79));
    _wait77.setNextCommand(array(1,(TMLCommand*)&_send78));
    _waitOnRequest.setNextCommand(array(1,(TMLCommand*)&_wait77));
...
void AppC__SmartCard::_lpIncAc93_func(){
    #ifdef ADD_COMMENTS
...
unsigned int AppC__SmartCard::_lpChoice93_func(ParamType& oMin, ParamType& oMax){
    unsigned int oC=0;
    oMin=-1;
    oMax=0;
    if ( x==0 ){
