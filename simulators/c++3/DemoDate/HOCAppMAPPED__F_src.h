...
class HOCAppMAPPED__F_src: public TMLTask {
    ...
    TMLRequestCommand _request232;
    TMLSendCommand _send233;
    TMLStopCommand _stop234;
    
    Parameter* _request232_func(Parameter* ioParam);
    Parameter* _send233_func(Parameter* ioParam);
