...
,size(0)
,arg1__req(0)
,_waitOnRequest(191,this,requestChannel,(ParamFuncPointer)&HOCAppMAPPED__X_acc::waitOnRequest_func,"\x1e\x0\x0\x0",false)
,_action196(196,this,(ActionFuncPointer)&HOCAppMAPPED__X_acc::_action196_func, "\x1d\x0\x0\x0",false)
,_read195(195,this,(LengthFuncPointer)&HOCAppMAPPED__X_acc::_read195_func,channel__HOCAppMAPPED__join1_ch_out__HOCAppMAPPED__acc_ch_in,"\x1d\x0\x0\x0",true)
,_execi192(192,this,(LengthFuncPointer)&HOCAppMAPPED__X_acc::_execi192_func,0,1,"\x1d\x0\x0\x0",false)
,_write194(194,this,(LengthFuncPointer)&HOCAppMAPPED__X_acc::_write194_func,channel__HOCAppMAPPED__acc_ch_out__HOCAppMAPPED__join2_ch_in1,"\x1c\x0\x0\x0",true)

{
    ...
    _varLookUpID[24]=&size;
    _varLookUpName["arg1__req"]=&arg1__req;
    _varLookUpID[139]=&arg1__req;
    ...
    //command chaining
    _write194.setNextCommand(array(1,(TMLCommand*)&_waitOnRequest));
    _execi192.setNextCommand(array(1,(TMLCommand*)&_write194));
    _read195.setNextCommand(array(1,(TMLCommand*)&_execi192));
    _action196.setNextCommand(array(1,(TMLCommand*)&_read195));
    _waitOnRequest.setNextCommand(array(1,(TMLCommand*)&_action196));
...
TMLLength HOCAppMAPPED__X_acc::_read195_func(){
    return (TMLLength)(size);
}

TMLLength HOCAppMAPPED__X_acc::_execi192_func(){
    return (TMLLength)(size);
}

TMLLength HOCAppMAPPED__X_acc::_write194_func(){
    return (TMLLength)(size);
}

void HOCAppMAPPED__X_acc::_action196_func(){
    #ifdef ADD_COMMENTS
