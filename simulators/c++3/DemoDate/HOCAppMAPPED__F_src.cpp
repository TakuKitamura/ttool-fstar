...
,r_size(0)
,_action231(231,this,(ActionFuncPointer)&HOCAppMAPPED__F_src::_action231_func, "\x2\x0\x0\x0",false)
,_request232(232,this,request__HOCAppMAPPED__r_src,(ParamFuncPointer)&HOCAppMAPPED__F_src::_request232_func,"\x2\x0\x0\x0",false)
,_send233(233,this,event__HOCAppMAPPED__src_evt_out__HOCAppMAPPED__fork1_evt_in,(ParamFuncPointer)&HOCAppMAPPED__F_src::_send233_func,"\x0\x0\x0\x0",false)
,_stop234(234,this)

{
    ...
    //command chaining
    _send233.setNextCommand(array(1,(TMLCommand*)&_stop234));
    _request232.setNextCommand(array(1,(TMLCommand*)&_send233));
    _action231.setNextCommand(array(1,(TMLCommand*)&_request232));
    _currCommand=&_action231;
    _firstCommand=&_action231;
    
    _channels[0] = event__HOCAppMAPPED__src_evt_out__HOCAppMAPPED__fork1_evt_in;
    refreshStateHash("\x2\x0\x0\x0");
}

Parameter* HOCAppMAPPED__F_src::_request232_func(Parameter* ioParam){
    return new SizedParameter<ParamType,1>(r_size);
}

Parameter* HOCAppMAPPED__F_src::_send233_func(Parameter* ioParam){
    return new SizedParameter<ParamType,1>(r_size);
}

void HOCAppMAPPED__F_src::_action231_func(){
    #ifdef ADD_COMMENTS
