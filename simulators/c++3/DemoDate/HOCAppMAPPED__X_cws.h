...
class HOCAppMAPPED__X_cws: public TMLTask {
    ...
    TMLActionCommand _action245;
    TMLReadCommand _read244;
    TMLExeciCommand _execi241;
    TMLWriteCommand _write243;
    
    Parameter* waitOnRequest_func(Parameter* ioParam);
    TMLLength _read244_func();
    TMLLength _execi241_func();
    TMLLength _write243_func();
    void _action245_func();
