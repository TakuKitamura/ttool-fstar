...
,r_size(0)
,arg1__req(0)
,_waitOnRequest(235,this,requestChannel,(ParamFuncPointer)&HOCAppMAPPED__X_src::waitOnRequest_func,"\xe\x0\x0\x0",false)
,_action239(239,this,(ActionFuncPointer)&HOCAppMAPPED__X_src::_action239_func, "\xd\x0\x0\x0",false)
,_execi236(236,this,(LengthFuncPointer)&HOCAppMAPPED__X_src::_execi236_func,0,1,"\xd\x0\x0\x0",false)
,_write238(238,this,(LengthFuncPointer)&HOCAppMAPPED__X_src::_write238_func,channel__HOCAppMAPPED__src_ch_out__HOCAppMAPPED__fork1_ch_in,"\xc\x0\x0\x0",true)

{
    ...
    _varLookUpID[45]=&r_size;
    _varLookUpName["arg1__req"]=&arg1__req;
    _varLookUpID[141]=&arg1__req;
    ...
    //command chaining
    _write238.setNextCommand(array(1,(TMLCommand*)&_waitOnRequest));
    _execi236.setNextCommand(array(1,(TMLCommand*)&_write238));
    _action239.setNextCommand(array(1,(TMLCommand*)&_execi236));
    _waitOnRequest.setNextCommand(array(1,(TMLCommand*)&_action239));
...
TMLLength HOCAppMAPPED__X_src::_execi236_func(){
    return (TMLLength)(r_size);
}

TMLLength HOCAppMAPPED__X_src::_write238_func(){
    return (TMLLength)(r_size);
}

void HOCAppMAPPED__X_src::_action239_func(){
    #ifdef ADD_COMMENTS
