...
,size(0)
,_wait168(168,this,event__HOCAppMAPPED__fork2_evt_out2__HOCAppMAPPED__cwm2_evt_in,(ParamFuncPointer)&HOCAppMAPPED__F_cwm2::_wait168_func,"\x3\x0\x0\x0",true)
,_request165(165,this,request__HOCAppMAPPED__r_cwm2,(ParamFuncPointer)&HOCAppMAPPED__F_cwm2::_request165_func,"\x3\x0\x0\x0",true)
,_send167(167,this,event__HOCAppMAPPED__cwm2_evt_out__HOCAppMAPPED__DMAcwm2_evt_in,(ParamFuncPointer)&HOCAppMAPPED__F_cwm2::_send167_func,"\x0\x0\x0\x0",true)
,_stop166(166,this)

{
    ...
    //command chaining
    _send167.setNextCommand(array(1,(TMLCommand*)&_stop166));
    _request165.setNextCommand(array(1,(TMLCommand*)&_send167));
    _wait168.setNextCommand(array(1,(TMLCommand*)&_request165));
    _currCommand=&_wait168;
    _firstCommand=&_wait168;
...
Parameter* HOCAppMAPPED__F_cwm2::_wait168_func(Parameter* ioParam){
    ioParam->getP(&size);
    return 0;
}

Parameter* HOCAppMAPPED__F_cwm2::_request165_func(Parameter* ioParam){
    return new SizedParameter<ParamType,1>(size);
}

Parameter* HOCAppMAPPED__F_cwm2::_send167_func(Parameter* ioParam){
    return new SizedParameter<ParamType,1>(size);
}
