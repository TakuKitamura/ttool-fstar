...
,size(0)
,_wait179(179,this,event__HOCAppMAPPED__fork3_evt_out1__HOCAppMAPPED__cwm1_evt_in,(ParamFuncPointer)&HOCAppMAPPED__F_cwm1::_wait179_func,"\x3\x0\x0\x0",true)
,_request176(176,this,request__HOCAppMAPPED__r_cwm1,(ParamFuncPointer)&HOCAppMAPPED__F_cwm1::_request176_func,"\x3\x0\x0\x0",true)
,_send178(178,this,event__HOCAppMAPPED__cwm1_evt_out__HOCAppMAPPED__fork2_evt_in,(ParamFuncPointer)&HOCAppMAPPED__F_cwm1::_send178_func,"\x0\x0\x0\x0",true)
,_stop177(177,this)

{
    //generate task variable look-up table
    _varLookUpName["size"]=&size;
    _varLookUpID[15]=&size;
    ...
    //command chaining
    _send178.setNextCommand(array(1,(TMLCommand*)&_stop177));
    _request176.setNextCommand(array(1,(TMLCommand*)&_send178));
    _wait179.setNextCommand(array(1,(TMLCommand*)&_request176));
    _currCommand=&_wait179;
    _firstCommand=&_wait179;
...
Parameter* HOCAppMAPPED__F_cwm1::_wait179_func(Parameter* ioParam){
    ioParam->getP(&size);
    return 0;
}

Parameter* HOCAppMAPPED__F_cwm1::_request176_func(Parameter* ioParam){
    return new SizedParameter<ParamType,1>(size);
}

Parameter* HOCAppMAPPED__F_cwm1::_send178_func(Parameter* ioParam){
    return new SizedParameter<ParamType,1>(size);
}
