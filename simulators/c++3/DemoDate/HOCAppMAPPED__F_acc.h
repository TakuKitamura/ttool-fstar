...
class HOCAppMAPPED__F_acc: public TMLTask {
    ...
    TMLWaitCommand _wait201;
    TMLRequestCommand _request198;
    TMLSendCommand _send200;
    TMLStopCommand _stop199;
    
    Parameter* _wait201_func(Parameter* ioParam);
    Parameter* _request198_func(Parameter* ioParam);
    Parameter* _send200_func(Parameter* ioParam);
