...
class HOCAppMAPPED__F_cwm1: public TMLTask {
    ...
    TMLWaitCommand _wait179;
    TMLRequestCommand _request176;
    TMLSendCommand _send178;
    TMLStopCommand _stop177;
    
    Parameter* _wait179_func(Parameter* ioParam);
    Parameter* _request176_func(Parameter* ioParam);
    Parameter* _send178_func(Parameter* ioParam);
