...
class AppC__Timer: public TMLTask {
    ...
    TMLSendCommand _send66;
    TMLWaitCommand _wait67;
    TMLStopCommand _stop64;
    TMLRandomChoiceCommand _choice64;
    
    unsigned int _choice64_func(ParamType& oMin, ParamType& oMax);
