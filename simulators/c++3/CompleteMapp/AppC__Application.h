...
class AppC__Application: public TMLTask {
    ...
    TMLSendCommand _send230;
    TMLWriteCommand _write231;
    TMLSendCommand _send232;
    TMLSendCommand _send235;
    TMLSendCommand _send234;
    TMLRandomChoiceCommand _choice229;
    
    unsigned int _choice229_func(ParamType& oMin, ParamType& oMax);
