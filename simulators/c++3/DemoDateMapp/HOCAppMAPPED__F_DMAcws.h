...
class HOCAppMAPPED__F_DMAcws: public TMLTask {
    ...
    TMLWaitCommand _wait184;
    TMLRequestCommand _request181;
    TMLSendCommand _send183;
    TMLStopCommand _stop182;
    
    Parameter* _wait184_func(Parameter* ioParam);
    Parameter* _request181_func(Parameter* ioParam);
    Parameter* _send183_func(Parameter* ioParam);
