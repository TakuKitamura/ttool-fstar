...
class HOCAppMAPPED__F_DMAcwm2: public TMLTask {
    ...
    TMLWaitCommand _wait194;
    TMLRequestCommand _request191;
    TMLSendCommand _send193;
    TMLStopCommand _stop192;
    
    Parameter* _wait194_func(Parameter* ioParam);
    Parameter* _request191_func(Parameter* ioParam);
    Parameter* _send193_func(Parameter* ioParam);
