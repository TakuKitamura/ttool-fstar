...
class HOCAppMAPPED__F_cwm2: public TMLTask {
    ...
    TMLWaitCommand _wait272;
    TMLRequestCommand _request269;
    TMLSendCommand _send271;
    TMLStopCommand _stop270;
    
    Parameter* _wait272_func(Parameter* ioParam);
    Parameter* _request269_func(Parameter* ioParam);
    Parameter* _send271_func(Parameter* ioParam);
