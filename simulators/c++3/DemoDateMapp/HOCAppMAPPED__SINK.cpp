...
,size(0)
,_wait282(282,this,event__HOCAppMAPPED__join2_evt_out__HOCAppMAPPED__sink_evt_in,(ParamFuncPointer)&HOCAppMAPPED__SINK::_wait282_func,"\x3\x0\x0\x0",true)
,_read280(280,this,(LengthFuncPointer)&HOCAppMAPPED__SINK::_read280_func,channel__HOCAppMAPPED__join2_ch_out__HOCAppMAPPED__sink_ch_in,"\x0\x0\x0\x0",true)
,_stop281(281,this)

{
    //generate task variable look-up table
    _varLookUpName["size"]=&size;
    _varLookUpID[74]=&size;
    ...
    //command chaining
    _read280.setNextCommand(array(1,(TMLCommand*)&_stop281));
    _wait282.setNextCommand(array(1,(TMLCommand*)&_read280));
    _currCommand=&_wait282;
    _firstCommand=&_wait282;
...
Parameter* HOCAppMAPPED__SINK::_wait282_func(Parameter* ioParam){
    ioParam->getP(&size);
    return 0;
}

TMLLength HOCAppMAPPED__SINK::_read280_func(){
