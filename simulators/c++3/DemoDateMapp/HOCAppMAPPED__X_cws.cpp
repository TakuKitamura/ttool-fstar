...
,size(0)
,arg1__req(0)
,_waitOnRequest(295,this,requestChannel,(ParamFuncPointer)&HOCAppMAPPED__X_cws::waitOnRequest_func,"\x1e\x0\x0\x0",false)
,_action300(300,this,(ActionFuncPointer)&HOCAppMAPPED__X_cws::_action300_func, "\x1d\x0\x0\x0",false)
,_read299(299,this,(LengthFuncPointer)&HOCAppMAPPED__X_cws::_read299_func,channel__HOCAppMAPPED__fork3_ch_out2__HOCAppMAPPED__cws_ch_in,"\x1d\x0\x0\x0",true)
,_execi296(296,this,(LengthFuncPointer)&HOCAppMAPPED__X_cws::_execi296_func,0,1,"\x1d\x0\x0\x0",false)
,_write298(298,this,(LengthFuncPointer)&HOCAppMAPPED__X_cws::_write298_func,channel__HOCAppMAPPED__cws_ch_out__HOCAppMAPPED__DMAcws_ch_in,"\x1c\x0\x0\x0",true)

{
    ...
    _varLookUpID[83]=&size;
    _varLookUpName["arg1__req"]=&arg1__req;
    _varLookUpID[155]=&arg1__req;
    ...
    //command chaining
    _write298.setNextCommand(array(1,(TMLCommand*)&_waitOnRequest));
    _execi296.setNextCommand(array(1,(TMLCommand*)&_write298));
    _read299.setNextCommand(array(1,(TMLCommand*)&_execi296));
    _action300.setNextCommand(array(1,(TMLCommand*)&_read299));
    _waitOnRequest.setNextCommand(array(1,(TMLCommand*)&_action300));
...
TMLLength HOCAppMAPPED__X_cws::_read299_func(){
    return (TMLLength)(size);
}

TMLLength HOCAppMAPPED__X_cws::_execi296_func(){
    return (TMLLength)(11 + size/2);
}

TMLLength HOCAppMAPPED__X_cws::_write298_func(){
    return (TMLLength)(size);
}

void HOCAppMAPPED__X_cws::_action300_func(){
    #ifdef ADD_COMMENTS
