...
,size(0)
,_wait199(199,this,event__HOCAppMAPPED__fork1_evt_out2__HOCAppMAPPED__DMAfork1_evt_in,(ParamFuncPointer)&HOCAppMAPPED__F_DMAfork1::_wait199_func,"\x3\x0\x0\x0",true)
,_request196(196,this,request__HOCAppMAPPED__r_DMAfork1,(ParamFuncPointer)&HOCAppMAPPED__F_DMAfork1::_request196_func,"\x3\x0\x0\x0",true)
,_send198(198,this,event__HOCAppMAPPED__DMAfork1_evt_out__HOCAppMAPPED__fork3_evt_in,(ParamFuncPointer)&HOCAppMAPPED__F_DMAfork1::_send198_func,"\x0\x0\x0\x0",true)
,_stop197(197,this)

{
    //generate task variable look-up table
    _varLookUpName["size"]=&size;
    _varLookUpID[31]=&size;
    ...
    //command chaining
    _send198.setNextCommand(array(1,(TMLCommand*)&_stop197));
    _request196.setNextCommand(array(1,(TMLCommand*)&_send198));
    _wait199.setNextCommand(array(1,(TMLCommand*)&_request196));
    _currCommand=&_wait199;
    _firstCommand=&_wait199;
...
Parameter* HOCAppMAPPED__F_DMAfork1::_wait199_func(Parameter* ioParam){
    ioParam->getP(&size);
    return 0;
}

Parameter* HOCAppMAPPED__F_DMAfork1::_request196_func(Parameter* ioParam){
    return new SizedParameter<ParamType,1>(size);
}

Parameter* HOCAppMAPPED__F_DMAfork1::_send198_func(Parameter* ioParam){
    return new SizedParameter<ParamType,1>(size);
}
