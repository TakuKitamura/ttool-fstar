...
class HOCAppMAPPED__X_DMAcws: public TMLTask {
    ...
    TMLActionCommand _action335;
    TMLActionCommand _lpIncAc330;
    TMLReadCommand _read334;
    TMLExeciCommand _execi331;
    TMLWriteCommand _write333;
    TMLRandomChoiceCommand _lpChoice330;
    TMLActionCommand _action399;
    
    Parameter* waitOnRequest_func(Parameter* ioParam);
    void _lpIncAc330_func();
    TMLLength _execi331_func();
    unsigned int _lpChoice330_func(ParamType& oMin, ParamType& oMax);
    void _action399_func();
    void _action335_func();
