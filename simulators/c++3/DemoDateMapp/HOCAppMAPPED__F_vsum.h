...
class HOCAppMAPPED__F_vsum: public TMLTask {
    ...
    TMLWaitCommand _wait262;
    TMLRequestCommand _request259;
    TMLSendCommand _send261;
    TMLStopCommand _stop260;
    
    Parameter* _wait262_func(Parameter* ioParam);
    Parameter* _request259_func(Parameter* ioParam);
    Parameter* _send261_func(Parameter* ioParam);
