...
,i(0)
,arg1__req(0)
,_waitOnRequest(344,this,requestChannel,(ParamFuncPointer)&HOCAppMAPPED__X_DMAsink::waitOnRequest_func,"\x3c\x0\x0\x0",false)
,_action351(351,this,(ActionFuncPointer)&HOCAppMAPPED__X_DMAsink::_action351_func, "\x39\x0\x0\x0",false)
,_lpIncAc346(346,this,(ActionFuncPointer)&HOCAppMAPPED__X_DMAsink::_lpIncAc346_func, 0, false)
,_read350(350,this,0,channel__HOCAppMAPPED__fork1_ch_out1__HOCAppMAPPED__DMAsink_ch_in,"\x3b\x0\x0\x0",true,1)
,_execi345(345,this,(LengthFuncPointer)&HOCAppMAPPED__X_DMAsink::_execi345_func,0,1,"\x3b\x0\x0\x0",false)
,_write349(349,this,0,channel__HOCAppMAPPED__DMAsink_ch_out__HOCAppMAPPED__join2_ch_in2,"\x3b\x0\x0\x0",true,1)
,_lpChoice346(346,this,(RangeFuncPointer)&HOCAppMAPPED__X_DMAsink::_lpChoice346_func,2,0, false)
,_action405(405,this,(ActionFuncPointer)&HOCAppMAPPED__X_DMAsink::_action405_func, 0, false)

{
    ...
    _varLookUpID[108]=&size;
    _varLookUpName["i"]=&i;
    _varLookUpID[109]=&i;
    _varLookUpName["arg1__req"]=&arg1__req;
    _varLookUpID[169]=&arg1__req;
    ...
    //command chaining
    _lpIncAc346.setNextCommand(array(1,(TMLCommand*)&_lpChoice346));
    _write349.setNextCommand(array(1,(TMLCommand*)&_lpIncAc346));
    _execi345.setNextCommand(array(1,(TMLCommand*)&_write349));
    _read350.setNextCommand(array(1,(TMLCommand*)&_execi345));
    _lpChoice346.setNextCommand(array(2,(TMLCommand*)&_read350,(TMLCommand*)&_waitOnRequest));
    _action405.setNextCommand(array(1,(TMLCommand*)&_lpChoice346));
    _action351.setNextCommand(array(1,(TMLCommand*)&_action405));
    _waitOnRequest.setNextCommand(array(1,(TMLCommand*)&_action351));
...
void HOCAppMAPPED__X_DMAsink::_lpIncAc346_func(){
    #ifdef ADD_COMMENTS
...
TMLLength HOCAppMAPPED__X_DMAsink::_execi345_func(){
    return (TMLLength)(size*2);
}

unsigned int HOCAppMAPPED__X_DMAsink::_lpChoice346_func(ParamType& oMin, ParamType& oMax){
    unsigned int oC=0;
    oMin=-1;
    oMax=0;
    if ( i == 0 ){
...
void HOCAppMAPPED__X_DMAsink::_action405_func(){
    #ifdef ADD_COMMENTS
...
void HOCAppMAPPED__X_DMAsink::_action351_func(){
    #ifdef ADD_COMMENTS
