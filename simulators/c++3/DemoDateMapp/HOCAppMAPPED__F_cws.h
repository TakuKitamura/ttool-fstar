...
class HOCAppMAPPED__F_cws: public TMLTask {
    ...
    TMLWaitCommand _wait257;
    TMLRequestCommand _request254;
    TMLSendCommand _send256;
    TMLStopCommand _stop255;
    
    Parameter* _wait257_func(Parameter* ioParam);
    Parameter* _request254_func(Parameter* ioParam);
    Parameter* _send256_func(Parameter* ioParam);
