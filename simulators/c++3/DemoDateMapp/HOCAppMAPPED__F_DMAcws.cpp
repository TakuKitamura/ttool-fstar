...
,size(0)
,_wait184(184,this,event__HOCAppMAPPED__cws_evt_out__HOCAppMAPPED__DMAcws_evt_in,(ParamFuncPointer)&HOCAppMAPPED__F_DMAcws::_wait184_func,"\x3\x0\x0\x0",true)
,_request181(181,this,request__HOCAppMAPPED__r_DMAcws,(ParamFuncPointer)&HOCAppMAPPED__F_DMAcws::_request181_func,"\x3\x0\x0\x0",true)
,_send183(183,this,event__HOCAppMAPPED__DMAcws_evt_out__HOCAppMAPPED__join1_evt_in3,(ParamFuncPointer)&HOCAppMAPPED__F_DMAcws::_send183_func,"\x0\x0\x0\x0",true)
,_stop182(182,this)

{
    //generate task variable look-up table
    _varLookUpName["size"]=&size;
    _varLookUpID[22]=&size;
    ...
    //command chaining
    _send183.setNextCommand(array(1,(TMLCommand*)&_stop182));
    _request181.setNextCommand(array(1,(TMLCommand*)&_send183));
    _wait184.setNextCommand(array(1,(TMLCommand*)&_request181));
    _currCommand=&_wait184;
    _firstCommand=&_wait184;
...
Parameter* HOCAppMAPPED__F_DMAcws::_wait184_func(Parameter* ioParam){
    ioParam->getP(&size);
    return 0;
}

Parameter* HOCAppMAPPED__F_DMAcws::_request181_func(Parameter* ioParam){
    return new SizedParameter<ParamType,1>(size);
}

Parameter* HOCAppMAPPED__F_DMAcws::_send183_func(Parameter* ioParam){
    return new SizedParameter<ParamType,1>(size);
}
