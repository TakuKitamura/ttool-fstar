...
public class DatagramServer implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            while (go) {
                ...
                String rcvd = rec + ", length=" + dgp.getLength() + ", from address: " + dgp.getAddress() + ", port: "
                        + dgp.getPort();
    ...
    public boolean sendDatagramTo(String s) {
        ...
        try {
            ...
            ;
            /*
             * if (notReceived) { // We assume "localhost" for the address
             * System.out.println("Datagram sending 1.1"); addr =
             * InetAddress.getByName("localhost"); } else {
             * System.out.println("Datagram sending 1.2"); addr = dgp.getAddress(); }
             */
