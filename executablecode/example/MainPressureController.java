...
public class MainPressureController extends JFrame implements Feeder, ChangeListener {
   ...
   * 
   * // START? if ((x>630)&&(x<720)&&(y>335)&&(y<365)) {
   * System.out.println("Mouse clicked on start"); if (ds != null) {
   * ds.sendDatagramTo("START"); } System.out.println("Action on start sent"); }
   * 
   * } public void mouseEntered(MouseEvent e){} public void mouseExited(MouseEvent
   * e){} public void mousePressed(MouseEvent e){} public void
